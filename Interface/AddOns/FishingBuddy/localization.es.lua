...
FishingTranslations["esES"] = {
	...
	CONFIG_AUTOLOOT_INFOD = "Despojar autom\195\161tico si desactivado porque FishWarden est\195\161 encendido", -- Needs review
	...
	CONFIG_EASYCAST_INFOD = "Lanzar f\195\161cil est\195\161  desactivado porque Fishing Ace! est\195\161 encendido", -- Needs review
	...
	CONFIG_MAINTAINRAFT_ONOFF = "Mantener solo", -- Needs review
	CONFIG_MAXSOUND_INFO = "Si activado, poner el volumen al m\195\161ximo mientras pesca", -- Needs review
	CONFIG_MAXSOUND_ONOFF = "Volumen total", -- Needs review
	...
	[" CONFIG_MINIMAPMOVE_INFO"] = "Si activado, el icono del minimapa puede ser movido", -- Needs review
	CONFIG_MINIMAPMOVE_INFO = "Si activo, el icono del minimapa puede ser movido", -- Needs review
	[" CONFIG_MINIMAPMOVE_ONOFF"] = "Movible", -- Needs review
	CONFIG_MINIMAPMOVE_ONOFF = "Movible", -- Needs review
	CONFIG_MOUNTEDCAST_INFO = "Si est\195\161 activado, permite pescar montado.", -- Needs review
...
Puntuaci\195\179n estilo Draznar's: %d ",
	...
	CONFIG_TURNONSOUND_INFO = "Si activado, siempre enciende los sonidos mientras pesca", -- Needs review
	...
	ROLE_TRANSLATE_ITIT = "Traducci\195\179n italiana", -- Needs review

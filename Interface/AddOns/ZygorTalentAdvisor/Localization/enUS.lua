...
ZygorTalentAdvisor_L("main", "enUS", function() return {
	...
	opt_build_header_pri = "Player build (primary spec)",
	opt_build_header_sec = "Player build (secondary spec)",
	...
	--opt_dualspec_pri = "This build is for your primary spec, |cffffee55%s|r. Switch specs to access your secondary spec's settings.",
	--opt_dualspec_sec = "This build is for your secondary spec, |cffffee55%s|r. Switch specs to access your primary spec's settings.",
	
	opt_petbmstatus_bm = "|cffff8800Warning:|r This pet build is for a |cffffee55non-Beast Mastery|r spec. As a |cffffee55Beast Master|r, you should use a Beast Mastery-enabled build for your pet.",
	opt_petbmstatus_notbm = "|cffff8800Warning:|r This pet build requires a |cffffee55Beast Mastery|r spec. You won't be able to complete it on a |cffffee55%s|r spec.",
	opt_petbmstatus_nospec = "|cffff8800Warning:|r Pet build choice depends on whether your character is a Beast Master or not. Please select a character spec, before assigning pet builds.",
	opt_pet_new = "|cffff8800Warning:|r You have a newly tamed pet. You have to dismiss and re-summon it to properly save a permanent build for it.",
	...
	status_green_nospec = "Your character has no specialization chosen yet. |cff88ff88Any build can be used|r.",
	...
	status_black_badspec = "This is a build for a |cffffee55%s|r specialization, while you have chosen |cffffee55%s|r.\nYou'll have to reset your talents or dualspec to use this build.",
	...
	status_black_errbadtalent = "badtalent: %s",
	status_black_errbadtalent2 = "badtalent2: %s",
	status_black_errbadclass = "badclass: %s",
	status_black_errnotalents = "notalents: %s",
	
	-- unloadable
	status_err_badblizzard = "This build contains broken Blizzard-style data.",
	status_err_brokenbuild = "|cffff0000Error:|r |cffffaaaaThis build contains unrecognized talents. It is broken and unusable.|r\n%s",
	status_err_builderror = "|cffff0000Error:|r |cffffaaaaThis build requires %d points in the talent '%s', while only %d are possible! It is broken and unusable|r.",
	...
	glyphmatch1 = ".- Glyph of (.+)",
	glyphmatch2 = "Glyph of (.+)",
} end)

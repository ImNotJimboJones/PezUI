...
L["Allow SexyMap to assume drag ownership for buttons attached to the minimap. Turn this off if you have another mod that you want to use to position your minimap buttons."] = "允许SexyMap 拖动依附在小地图上的按钮。如果你用其他的插件来拖动按钮，请关闭此功能。"
...
L["Enable Hudmap"] = "启用HUD地图"
L["Enable Minimap Fader"] = "启用小地图淡出"
L["Enable Movers"] = "启用框体移动"
...
L["HUD Color"] = "HUD颜色"
L["If you zoom into the map, this feature will automatically zoom out after the selected period of time (seconds)"] = "如果你放大地图，此功能会在选择的时间（秒）后自动缩小。"
L["Keybinding"] = "按键绑定"
L["Layer"] = "层级"
L["Let SexyMap control button visibility"] = "SexyMap管理按钮可见性"
L["Let SexyMap handle button dragging"] = "SexyMap接管按钮拖动"
L["Lock Button Dragging"] = "锁定按钮拖动"
L["Lock Coordinates"] = "锁定坐标"
L["Lock Minimap"] = "锁定小地图"
L["Lock Movers"] = "锁定框体移动"
L["Map Button"] = "地图按钮"
...
L["On Hover"] = "悬停时"
L["Opacity"] = "不透明"
L["Open TexBrowser"] = "打开TexBrowser"
L["Ping"] = "点击小地图"
L["Preset"] = "预设配置"
L["Prevent the minimap from being moved off the screen"] = "防止小地图被移出屏幕外"
L["Profiles"] = "配置文件"
L["Queue Status Button (When Available)"] = "排队状态按钮（可用时）"
...
L["Right clicking the map will open the SexyMap options"] = "右键点击地图打开SexyMap设置"
...
L["SharedMedia Border"] = "SharedMedia边框"
L["SharedMedia Texture"] = "SharedMedia材质"
...
L["TexBrowser Not Installed"] = "没有安装TexBrowser"
L["Text Color"] = "文本颜色"
L["Texture"] = "材质"
...
L["Use GatherMate pins"] = "显示GatherMate资源点"
L["Use QuestHelper pins"] = "使用QuestHelper资源点"
L["Use Routes"] = "显示路线"
L["Vehicle Seat"] = "载具座位"
L["Vertical Nudge"] = "垂直位移"
L["Vertical Position"] = "垂直位置"
L["Video Recording Button (Mac OSX Only, When Available)"] = "饰品录制按钮（仅限Mac OSX，可用时）"

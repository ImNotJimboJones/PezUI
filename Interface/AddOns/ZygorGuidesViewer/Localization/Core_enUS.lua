...
If you're new to the guides, or have only started using them on this character, you can use the |cffddff00Smart Injection System|r to automatically find a proper starting spot for you. It might turn out to be far below your current level, if you skipped some useful quest chains or flight points, but the guide will catch up once you complete them.",
	...
	['opt_group_convenience_desc'] = "Various things that we thought might be useful.",
		...
		['opt_detectcreatures']= "Detect pets and mounts",
		['opt_detectcreatures_desc']= "Display a shortcut on the unitframe to open the guide corresponding to a selected mount or pet.",
		['opt_silentmode'] = "Silent mode of operation",
		['opt_silentmode_desc'] = "Suppresses most output forms from the guide, so that it does not interfere with the chat window.",
	...
	["report_nomount_dialog"] = "|cffff8888Zygor Guides Mount Detector|r\n\nThe targeted unit is either unmounted or we don't know the mount they are using. In the latter case, you could help us improve the guides by reporting this exact player mount to us. Are you positive the target is mounted?",
	["report_nopet_dialog"] = "|cffff8888Zygor Guides Pet Detector|r\n\nThe targeted unit is either not a pet or we don't know the pet you have targeted. In the latter case, you could help us improve the guides by reporting this exact pet to us. Are you positive the target is a pet?",
	...
	["detector_mount_tooltip"] = "This mount is found in the guides, click at \nthis button to open the corresponding guide.",
	["detector_pet_tooltip"] = "This pet is found in the guides, click at \nthis button to open the corresponding guide.",

...
If you're new to the guides, or have only started using them on this character, you can use the |cffddff00Smart Injection System|r to automatically find a proper starting spot for you. It might turn out to be far below your current level, if you skipped some useful quest chains or flight points, but the guide will catch up once you complete them.",
	...
	['opt_group_conv'] = "Extra features",			['opt_group_conv_desc'] = "Various things that we thought might be useful.",
		...
		['opt_autoacceptturninall_'] = "Accept or turn in any quest",	['opt_autoacceptturninall__desc'] = "Auto-accept or turn in ANY quest, even if not following a guide.",
		...
		['opt_autoacceptturninall_acceptturnin'] = "Accept or turn in any quest",	['opt_autoacceptturninall_acceptturnin_desc'] = "Auto-accept or turn in ANY quest, even if not following a guide.",
		['opt_autoselectitem'] = "Select quest rewards",			['opt_autoselectitem_desc'] = "Automatically turn in quests and select reward if available.\nReward selection process looks at class and spec and picks the biggest upgrade for you from the quest items. If no upgrades are available then picks the item that has the highest vendor value.\n|cffffaa88No known problems, but item selection process may not be perfect.\nDoes not take off specs into account.",
		...
		['opt_showgrayvalue'] = "Show value of grays",				['opt_showgrayvalue_desc'] = "Show window to view value of current gray items.",
		['opt_showgraysellbutton'] = "Show vendor button",			['opt_showgraysellbutton_desc'] = "Show the button to automatically sell gray items in the vendor window.",
		...
		['opt_clearnotupgrades'] = "Clear wrong upgrades",			['opt_clearnotupgrades_desc'] = "Clear the list of items that are ignored as upgrades, because either your current item is better, or you declined an upgrade.\n|cffffaa88Clearing this will cause the confirm box to pop up again on previously declined items.",
...
--]]
	...
	['guideconfig_check6'] = " Auto-Sell Gray Items",
	...
	loot_sellgrays_sold = "Sold |cffffdd00%d|r x %s for |cffffdd00%s|r",
	loot_sellgrays_total = "Total income: %s",
	loot_grayframe_maintext = "Total value of gray items",
	loot_sellgraybutton = "Sell Grays",
} end)

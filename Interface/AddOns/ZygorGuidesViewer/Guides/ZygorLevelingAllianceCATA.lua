...
condition suggested raceclass('Worgen') and not completedq(28517) and not raceclass('DEATHKNIGHT')
...
step
goto 66.3,61.6
.' Use your Immolate ability on a Bloodfang Worgen
...
step
goto 67.8,64.2
.' Use your Steady Shot ability on a Bloodfang Worgen |kill ##35118 |n
...
step
goto 55.7,81.5 |n
.' Click the Cellar Door and go down the steps |click Cellar Door##9028 |goto 55.8,81.5,0.5 |noway |c
step
goto 56.8,85.4
.talk 35369
..turnin 14159
...
step
goto 31.3,72.7
.clicknpc Click Crowley's Horse##44429 |invehicle |c |q 14212
step
...
' |from Disturbed Spirit##37884+, Forsaken Footsoldier##36810+, Forsaken Infantry##38616+, Forsaken Slavedriver##37701+, Forsaken Crossbowman##38210+, Forsaken Infantry##38192+, Forsaken Sailor##36396+, Forsaken Soldier##37805+, Forsaken Footsoldier##36236+, Forsaken Infantry##37692+, Forsaken Sergeant##38618+, Restless Ancestor##37885+
step
goto 25.1,72.3
.' Find a Forsaken Catapult and kill the Forsaken Machinist driving it. |kill Forsaken Machinist##36292 |n
.clicknpc Forsaken Catapult##36283 |invehicle |c |q 14382
step
goto 25.0,74.7
...
step
goto 39.6,78.8
.clicknpc Mountain Horse##36540 |tip Click to ride it
...
step
goto 46.7,83.3
.click the Koroth's Banner##6957
...
step
goto 30.3,61.0
.click Captured Riding Bat##38615
...
step
goto 25.8,41.9
.click Crucible of Air##39736
.' Activate the Crucible of Air |q 25303/2
step
goto 26.0,41.6
.click Crucible of Water##39738
...
.click a Lightning Channel##9816
...
.clicknpc Abyssal Seahorse##39629 |q 25371
step
...
..turnin 25371
step
'Use your Subdued Abyssal Seahorse |use Subdued Abyssal Seahorse##54465
...
.collect Ancient Elven Etching##62281 |n |tip You will need to kill the Azh'ir Mobs until you get this to drop.
...
.' Slay 100 Azsh'ir Solider##41249+ |q 25752/2
.' Slay 20 Wave Screamer##41250+ |q 25752/3
.' Slay 12 Azsh'ir Archaean##42549+ |q 25752/4
step
goto 39.1,78.7
.talk 40643
..turnin 25752
...
step
goto 47.5,26.8
.click Petrified Stone Bat##43182+
...
.clicknpc the Titan Mechanism##50401
..turnin 27903
step
goto 44.0,57.1
.talk 46978
...
.click Desert Fox##47201 |tip It runs around a lot, so you will probably have to search for it to find it.
...
.' Use your Licensed Proton Accelerator Cannon on Furious Spectors once they are at half health |use Licensed Proton Accelerator Cannon##62794
...
.kill Major Samuelson##2439 |q 27106/2
step
goto 85.8,31.7
.talk 29611
..turnin 27106
...
.click Thundermar Ale Keg##04631+
...
step
goto 41.8,11.4
.kill 3 Tentacle of Iso'rath##48796 |q 27299/1
step
goto 44.0,10.6
.talk 45332
..turnin 27299

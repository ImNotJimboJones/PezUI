...
.' You can find more around [Dun Morogh,38.0,66.8]
step
goto 35.8,66.3 
.talk 1104
..turnin 24477
...
.' Practice using Arcane Missiles 2 times |q 24526/1
only Dwarf Mage
step
goto 35.7,64.8
.talk 37121
...
.' Practice Primal Strike 2 times |q 24527/1
only Dwarf Shaman
step
goto 35.7,64.6
.talk 37115
...
..turnin 13188
step
'Fly to Nethergarde Keep |goto Blasted Lands,61.2,21.6,0.5 |noway |c
]])
...
step
goto 77.1,18.5
.clicknpc Repaired Bomber##27665
...
step
goto 79.7,14.8
.kill Gor'kresh##44771+ |q 27078/1
step
goto 74.8,19.8 |n
...
.kill Horghast Flarecrazed##41554 |q 25780/1
step
goto 10.5,55.7
.talk 2104
..turnin 25780
...
' |from Bluegill Murloc##41425+, Bluegill Oracle##41426+, Bluegill Forager##42111+
step
goto 13.9,34.8
...
' |from Highland Razormaw##25864, Highland Scytheclaw##41401
step
goto 26.8,25.9
.talk 41435
..turnin 25854
...
step
goto 41.2,21.9
.kill Yorla Darksnare##41524 |q 25868/1
step
goto 26.9,26.1
.talk 41415
..turnin 25868
...
' |from Dragonmaw Centurion##1036+, Dragonmaw Shadowwarder##1038+, Dragonmaw Shadowwarder##1038+, Dragonmaw Raider##1034+
step
goto 38.9,39.4
.talk 41411
..turnin 26189
...
.|from Syndicate Mercenary##2589+, Syndicate Pathstalker##2587+, Syndicate Highwayman##2586+
step
...
step
goto 19.4,64.8
.from Syndicate Thief##24477+, Syndicate Prowler##2588+, Syndicate Conjuror##2590+
...
step
goto 58.8,68.4
.from Witherbark Axe Thrower##2554+, Witherbark Witch Doctor##2555+, Witherbark Headhunter##2556+
...
.' Use the Gryphon Chow to feed Trained Razorbeaks |use Gryphon Chow##58935 |tip They look like gryphons flying low around this area.
...
.click Skitterling Spiderlings##1160+ |tip They are really small, so keep an eye out for them.
...
.click Vessels of Tainted Blood##216+ |tip They are rare, except on the almost top level of Jintha'Alor, so you may need to search hard for them.
...
.' You will fly to the top of Jintha'Alor |goto 53.2,66.6,0.5 |noway |c
step
goto 54.4,67.6 |n
.' Enter the tunnel |goto 54.4,67.6,0.5 |noway |c
step
goto 59.4,77.7
.click Sacrificed Vilebranches##28240+
...
step
goto 53.3,66.6
.click Sharpbeak##676 |tip It's an armored gryphon flying in place in this spot.
.' You will fly down from Jintha'Alor |goto 63.5,60.1,0.5 |noway |c
step
goto 63.7,60.0
.talk 43156
...
step
goto 31.9,46.8
.click Highvale Record##210
.get Highvale Records |q 27626/2
step
goto 29.6,48.7
.click Highvale Note##210
...
step
goto 26.9,21.9
.kill Yowler##518 |q 26545/1 |tip He is a level 16 elite, so you should be able to kill him easily.
...
dynamic on
step
.' Go South East to Hillsbrad Foothills |goto Hillsbrad Foothills |noway |c
step
goto Hillsbrad Foothills,54.8,27.1 |n
.' Follow this arrow to Western Plaguelands [Western Plaguelands,44.0,85.4] |n
.' Go to Western Plaguelands. |goto Western Plaguelands |noway |c
step
...
goto Western Plaguelands,42.9,85.1
.talk 12596
.' Tell him you need a Gryphon to Andorhal.
.' Go to Andorhal |goto Western Plaguelands,39.5,69.5 |noway |c
step
...
.talk 12596
.' Fly to Menders' Stead, Western Plaguelands |goto Western Plaguelands,50.5,52.4,0.5 |noway |c
step
goto 48.9,54.8
.talk 44456
..accept 27683
...
goto 50.5,52.2
.talk 46011
.' Fly to Thondoril River, Eastern Plaguelands |goto Eastern Plaguelands,10.1,65.8,0.5 |noway |c
]])
...
.click Slain Scourge Trooper##9786+
...
.kill Mataus the Wrathcaster##16133 |q 27615/1
step
goto 74.9,78.3
.' Go upstairs into the big main room in the fortress
.kill Scarlet Commander Marjhan##16114 |q 27619/1
step
goto 74.5,77.5
.' Go down the hall and up more stairs
.kill Huntsman Leopold##16132 |q 27616/1
step
goto 75.3,76.2
.talk 16112
..turnin 27614
...
step
goto 77.8,71.0
.' Click the Argent Portal |tip It looks like a swirling portal on this square wooden table upstairs in a side room inside the building.  Follow the stairs up in the Library Wing, not the big spiral stairs in the middle of the building.
...
.kill Rohan the Assassin##16131 |q 27613/1
step
goto 76.7,73.1
.talk 16115
..turnin 27612
...
step
.' The path up to Fuselight starts at [Badlands,68.8,31.7].
goto 65.1,38.4
.talk 46652
..turnin 27763
..accept 27774
...
step
goto 48.6,51.0
.' Click the Sentinel's Pawn 2 times |tip It looks like a small stone golem. |modelnpc 46398
.' Click to proceed |confirm
step
goto 48.0,51.3
.' Click the Sentinel's Pawn 1 time |tip It looks like a small stone golem. |modelnpc 46398
.' Click to proceed |confirm
step
goto 49.0,51.7
.' Click the Sentinel's Pawn 2 times |tip It looks like a small stone golem. |modelnpc 46398
...
.kill Kalaran the Annihilator##46859+ |q 27829/1 |tip He's a big red dragon that flies around in the air around this area.
...
goto 10.7,39.5
.' Use the 3 dwarves' abilities on your pet bar to fight
.kill Nyxondra##46861 |q 27831/1 |tip She's a big red dragon flying in a circle in the sky around this area.  Clear out a big area by killing Nyxondra's Hatchlings before you try to fight Nyxondra because she fears you while you fight her.
...
' |from Dark Iron Footman##47275, Dark Iron Watchman##8637
step
goto 68.5,53.3
.talk 47267
..turnin 27960
...
|fly Iron Summit
step
.' Follow this path through Blackrock Mountains to Burning Steppes.
map Burning Steppes
path follow loose;loop off;ants straight // this stays until the end of the guide.
path	 19.4,24.3	17.4,28.6	19.1,33.3
path	 20.2,36.2	21.2,39.7
.' Once you're at the giant bridge, click here to proceed. |confirm
]])
...
goto 17.3,52.1
.talk 47811
..' You will only be able to accept 1 of these 2 quests |tip Which quest is offered to you defends on whether or not you completed a quest line in Redridge Mountains at a lower level.
..accept 28416 |or
..accept 28174 |or
step
goto 17.0,51.3
...
step
goto 17.5,60.5
.click Fettered Green Whelpling##694
.' Free a Green Whelpling |q 28172/2
step
goto 19.2,61.6
.click Fettered Blue Whelpling##9994
...
step
goto 15.1,69.7
.click Fettered Bronze Whelpling##14720
.' Free a Bronze Whelpling |q 28172/4
step
goto 14.2,66.8
.click Fettered Red Whelpling##956
...
.' Wear your Blackrock Orc Disguise |havebuff Interface\Icons\Achievement_Character_Orc_Male |q 28239 |or
.' Wear your Blackrock Orc Disguise |havebuff Interface\Icons\Achievement_Character_Orc_Female |q 28239 |or
.' Wear your Blackrock Orc Disguise |havebuff Interface\Icons\Achievement_Character_Troll_Male |q 28239 |or
.' Wear your Blackrock Orc Disguise |havebuff Interface\Icons\Achievement_Character_Troll_Female |q 28239 |or
.' Wear your Blackrock Orc Disguise |havebuff Interface\Icons\Achievement_Character_Goblin_Male |q 28239 |or
.' Wear your Blackrock Orc Disguise |havebuff Interface\Icons\Achievement_Character_Goblin_Female |q 28239 |or
.' Wear your Blackrock Ogre Disguise |havebuff Interface\Icons\Achievement_Reputation_Ogre |q 28239 |or
step
goto 45.3,51.7
.talk 48085
..turnin 28239
...
.kill Gorlop##9176 |q 28246/1 |tip He's an ogre that runs back and forth between the 2 lava pools here, so you may need to search for him.
.' Click the Quest Complete box that displays on the right side of the screen under your minimap
..turnin 28246
step
goto 39.7,55.7
...
.click Deceased Bogpaddle Privateer##34757+
...
goto 98.8,27.2
.' Go downstairs
.click Stack of Questionable Publication##43
...
.' Defeat Jammal'an the Prophet##46656 |q 27773/1
.' Click the Quest Complete box that displays on the right side of the screen under your minimap
..turnin 27773
..accept 27914
step
...
step
goto 53.9,50.0
.' While the Horde Portal Sentry has his back turned to you, click the Horde Plans |tip Click the plans as soon as the Horde Portal Sentry has his back turned to you while he's pacing, or else he will attack you when you try to get the plans. |model 222
...
step
goto 79.9,46.3
.' Use your Seal of Righteousness ability, then use your Judgement ability on a Training Dummy |modelnpc 44703
...
step
goto 79.8,45.8
.' Use your Steady Shot ability on the Training Dummy |modelnpc 44703
...
step
goto 79.7,45.9
.' Use your Charge ability on a Training Dummy |modelnpc 44703
...
.from Wrathscale Myrmidon##17194+, Wrathscale Naga##17193+, Wrathscale Siren##17195+ |nomodels
...
step
goto Azuremyst Isle,59.6,67.6
.' Click the Nautical Compass##6846
.get Nautical Compass##23738 |q 9506/1
step
goto Azuremyst Isle,47,70.2
.talk 17240
...
step
goto 62.3,53.0
.' Click a Blood Mushroom##6874+ |tip It looks like a red-ish glowing mushroom on the ground.
...
.' Around [Bloodmyst Isle,44.6,38.0]
step
goto 42.1,21.2
.talk 17421
..turnin 10063
...
..turnin 9548
..turnin 9549
.collect Weathered Treasure Map##23837 |n
...
step
goto 41.3,30.9
.' Use your Crystal Mining Pick next to the Axxarien Crystal |use Crystal Mining Pick##23877 |tip It looks like a huge red crystal on the ground.
...
..accept 10067
..accept 10066
.' If this quest giver does not offer the quests, you can find another NPC here that may [51.8,52.0]
step
goto 53.2,57.0
.talk 17676
..accept 9669
step
goto 37.5,61.2
.clicknpc Galaen's Corpse##17046
..turnin 9578
..accept 9579
...
.from Webbed Creature##17680+ |tip They look like white squirming cocoons on the ground around this area.
step
goto 19.7,31.9
...
goto 54.4,54.3
.talk 17824
..' Tell her you're a prisoner and the draenei filth captured you as you exited the sun gate
...
.' You can find more around [Teldrassil,54.6,38.7]
step
goto 58.1,39.0
.talk 2079
..turnin 28714
...
goto Teldrassil,58.2,34.8
.talk 3597
.' Learn Rejuvenation |q 26948/2
only NightElf Druid
step
goto 58.7,36.5
.' Use your Rejuvenation spell on Wounded Sentinel
.' Practice Rejuvenation |q 26948/1
only NightElf Druid
step
goto 58.2,34.8
.talk 3597
...
.' Ride Janki's Mount to Nijel's Point |goto 64.8,10.5,0.5 |noway |c
step
goto 64.7,10.5
.talk 6706
.fpath Nijel's Point
...
step
goto 43.9,71.2
.kill 10 Desolation Raider##37922+ |q 25081/1
step
goto 46.0,71.5 |n
...
step
goto 77.2,45.9
.kill Sporewing##18280 |q 9901/1 |tip He looks like a Sporebat.
step
goto 80.7,43.4
...
.kill Withered Bog Lord##19402+ |n
...
step
goto 79.7,70.1
.kill Umbraglow Stinger##18132+ |n
.get 8 Diaphanous Wing|q 9790/1
step
goto 82.6,43.7
.kill Parched Hydra##20324+ |n
...
step
goto 17.3,38.4
.kill Marshlight Bleeder##18133+ |n |tip They are all around this area on the land, to the north and south.
...
step
goto 42.2,41.4
.kill Mragesh##18286 |q 9905/1 |tip He is a big brown hydra underwater.
step
goto 23.3,66.2
.talk 17831
..turnin 9709
...
..turnin 9905
step
'Fly to Telredor |goto Zangarmarsh,67.9,51.4,2 |noway |c
step
goto 68.2,49.4
.talk 18003
..turnin 9786
...
' |from Sporebat##18128+, Fen Strider##18134
step
goto 68.2,49.4
.talk 18003
..turnin 9801
...
step
goto 44.1,23.8
.kill Vicious Teromoth##18437+ |n
.get 4 Vicious Teromoth Sample|q 9968/2
step
goto 45.8,29.8
.kill Teromoth##18468+ |n
...
' |from Skithian Windripper##18452+,Skithian Dreadhawk##18452+
step
goto 30.8,42.1
...
.' You can find more Timber Worgs at [Terokkar Forest,36.8,37.5]
step
goto 30.1,42.5|n
...
step
goto 54.1,32.1
.' Click the Draenei Vessels on the ground |tip They look like little pink glowing lanterns. Not all of the little lanterns give you a Draenei Vessel, some will AoE you. Note: you can reach some of them through the walls.
...
step
goto 67.9,79.3
.kill 10 Kil'sorrow Agent##21276+ |q 9936/2
step
goto 71.1,82.4
...
goto 73.2,40
.' Put on your Felsworn Gas Mask |use Felsworn Gas Mask##31366
.' Click the Legion Communicator |tip Between 2 big green floating crystals.  Must be wearing the Felsworn Gas Mask to use this. |tip Between 2 big green floating crystals.  Must be wearing the Felsworn Gas Mask to use this.
..turnin 10820
step
goto 55.2,24
...
.' Walking over the eggs inside of the cave will force Wyrmcult Blackwhelps to spawn.
.' Kill Wyrmcultists
...
step
goto 44.2,12.6
.' Click the Dome Generator Segment |tip They look like small glass containers with pink electricity in them around this area.
...
.' You can find more Diemetradon's and Ever-Burning Ash at [Shadowmoon Valley,45.8,61.4]
.from Felboar##21878+, Vilewing Chimaera##21879+
.kill 20 Shadowmoon Valley Wildlife##21978+ |q 10703/1
step
ding 69
step
 goto 42.2,45.1
...
step
goto 37.2,56.6
.' Use the Spectrecles in your bags. |use Spectrecles##30719
...
step
goto 40.7,21.7
.' Click the Fel Reaver Control Console to take control of a Fel Reaver Sentinel |tip It looks like a metal box with a bunch of levers on it.  If you are a hunter or warlock you will have to dismiss your pet first.
...
.talk 18940
.' Fly to Wildhammer Stronghold, Shadowmoon Valley |goto Shadowmoon Valley,37.6,55.5,0.3 |noway |c
only if rep ('The Scryers') >= Neutral
step
...
only if rep ('The Aldor') >= Neutral
step
'Go inside of the Deathforge |goto 40.1,38.2,0.5 |c
only if rep ('The Aldor') >= Neutral
step
goto 40.0,38.4
...
.' Click Frostberry Bushes |tip They look like small snow-covered bushes on the ground all around this area.
.get 10 Frostberry |n
...
.' Plant the Warsong Banner in Magmothregar |goal Warsong Banner Planted in Magmothregar |q 11670/1
step
'Go outside to 57.6,18.7 |goto 57.6,18.7
.talk 25477
..turnin 11670
...
goto 56.9,29.1
.kill mammoths|n
.get 6 Thick Mammoth Hide|q 11718
...
.kill 1 Lord Kryxix##25768 |q 11723/1
step
...
.talk 26602
.' Fly to Vlagarde Port, Howling Fjord |goto Howling Fjord,59.8,63.2,0.5 |noway |c
]])
...
step
goto 44.2,30.4
.kill Drakkari Defender##26704+|n
...
' |from Frostpaw Shaman##26428, Frostpaw Trapper##26434, Frostpaw Warrior##26357, Redfang Hunter##26356, Redfang Elder##26436
step
goto 48.1,58.9
.talk 27274
...
' |from Forgemaster Damrath##26334, Rune Reaver##26268, Iron Rune-Shaper##26270
step
goto 59.8,27.5
.talk 26226
..turnin 12003
...
.from Iron Rune Overseer##27177+, Iron Rune-Smith##26408+, Runic Lightning Gunner##26414+, Rune-Smith Durar##26409+
step
goto 76.8,59.4
...
.' Click Loken's Pedastal |tip Go up the hill into this building at the end of the path.  It's a big square stone altar thing inside this building.
...
goto 14.1,73.8
.talk 28518
.' You will only be able to turn in and accept 1 of these quests
..turnin 12638 |or 2
..turnin 12637 |or 2
..accept 12643 |or 2
..accept 12629 |or 2
...
.talk 28589
..accept 12652
..buy 1 Bitter Plasma|q 12649/1 |or
..buy 1 Bitter Plasma|q 12648/1 |or
step
goto 20.5,74.8
...
..accept 12521
step
'Go underground into the sewer to 45.4,40.8 |goto Dalaran/2,45.4,40.8
.talk 30137
..accept 12974
step
...
.kill Cursed Offsprings of Har'koa##28404+ |n
...
step
goto 54,49.1
.kill Priests of Rhunok##28417+ |n
...
step
goto 64.1,69.9
.kill Har'koan Subduer##28403+ |n
.kill Claws of Har'koa##28402+ |n
...
.kill High Priest Tua-Tua##28754 |n
...
.kill High Priest Hawinni##28756 |n
...
step
goto 70.5,50.4
.kill Blood of Mam'toth##28779+ |n
...
..turnin 12707
step
'Fly to Gundrak |goto Zul'Drak,70.5,23.2,0.5 |noway |c
step
goto 78.1,24.2
...
goto 39.7,58.7
.talk 27987
..turnin 12521 |tip You will only be able to turn in this quest if you have completed Zul'Drak (75-77)
step
goto 39.7,58.7
..accept 12489
...
.kill 10 Eclipsion Spellbinder##22017+ |q 10773/3
step
...
step
 goto 52.5,57.3
.' Use your Spectrecles to equip them

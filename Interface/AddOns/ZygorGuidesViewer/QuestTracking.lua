...
me.instantQuests = {}
me.completedQuests = {}
-- me.completedQuestTitles = {}  -- let's not use this anymore, with GetQuestID available
...
function me:AbandonedQuestEvent(questTitle,id,daily)
...
function me:QUEST_COMPLETE_QuestTracking()
...
function me.QuestTracking_hook_SetAbandonQuest()
...
function me.QuestTracking_hook_AbandonQuest()
...
--[=[
function me:GetQuestRemainingInChain(questid)
...
function me:IsQuestExclusived(questid)
...
function me:AbandonUselessQuests()
	for qi,quest in ipairs(self.quests) do

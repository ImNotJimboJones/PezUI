...
function ZygorGuidesViewerFrame_Step_Setup(num)
	...
	step:SetBackdrop({bgFile = ZGV.DIR.."\\Skins\\white", edgeFile=ZGV.DIR.."\\Skins\\Midnight\\Black\\roundcorners", tile = true, edgeSize=8, tileSize = 8, insets = { left = 8, right = 8, top = 8, bottom = 8 }})
	step.border:SetBackdrop({bgFile=nil,edgeFile=ZGV.DIR.."\\Skins\\midnight\\black\\border-glow", tile = true, edgeSize=8, tileSize = 8, insets = { left = 8, right = 8, top = 8, bottom = 8 }})
	...
	for i=1,30,1 do
		...
		back:SetBackdrop({bgFile = ZGV.DIR.."\\Skins\\white", edgeFile=ZGV.DIR.."\\Skins\\Midnight\\Black\\roundcorners", tile = true, edgeSize=6, tileSize = 6, insets = { left = 6, right = 6, top = 6, bottom = 6 }})
		
		-- back:SetBackdrop({bgFile = ZGV.DIR.."\\Skins\\white", edgeFile=ZGV.DIR.."\\Skins\\Midnight\\Black\\roundcorners", tile = true, edgeSize=8, tileSize = 8, insets = { left = 8, right = 8, top = 8, bottom = 8 }})
		-- won't work until back is a frame


		clicker:ClearAllPoints()
		clicker:SetBackdrop({bgFile = ZGV.DIR.."\\Skins\\white",edgeFile=ZGV.DIR.."\\Skins\\midnight\\black\\roundcorners", tile = true, edgeSize=6, tileSize = 6, insets = { left = 6, right = 6, top = 6, bottom = 6 }})
...
function ZygorGuidesViewerFrame_Spot_Setup(num)
	...
	spot:SetBackdrop({bgFile = ZGV.DIR.."\\Skins\\white", edgeFile=ZGV.DIR.."\\Skins\\Midnight\\Black\\roundcorners", tile = true, edgeSize=8, tileSize = 8, insets = { left = 8, right = 8, top = 8, bottom = 8 }})
...
function ZygorGuidesViewerFrame_OnLoad(self)
	...
	Border:SetBackdrop({bgFile=ZGV.DIR.."\\Skins\\white",edgeFile=ZGV.DIR.."\\Skins\\midnight\\black\\border", tile = true, edgeSize=20, tileSize = 128, insets = { left = 20, right = 20, top = 20, bottom = 20 }})
	Border.TitleBar.Logo:SetTexture(ZGV.DIR.."\\Skins\\zygorlogo")
...
--	this:RegisterEvent("PARTY_MEMBER_DISABLE");
	...
	ZygorGuidesViewerFrame_Border_Guides_SectionTitle:SetFont(ZGV.DIR.."\\Skins\\SegoeUI.TTF",11)
...
function ZygorGuidesViewerFrame_HelpButton_OnClick(self,button)
	--StaticPopup_Show('ZYGORGUIDESVIEWER_HELP')
end
...
function ZygorGuidesViewerFrame_Guides_GuideButton_OnClick(self,button)
	local path
	if (ZGV.GP.Frame and ZGV.GP.Frame:IsVisible() and ((button=="RightButton")==(ZGV.GP.path=="SUGGESTED"))) then
		ZGV.GP:Hide()
	else

...
locales.zhCN["bind_on_equip_short"] = "装绑"
locales.zhCN["bind_on_pickup_short"] = "拾绑"
locales.zhCN["bind_on_use_short"] = "用绑"
locales.zhCN["button_close"] = "关闭"
locales.zhCN["button_link"] = "链接"
locales.zhCN["linkall_threshold_missed"] = "所有物品都低于最低品质限制"
locales.zhCN.config = {
	font_size_info = "物品信息字体大小",
	font_size_loot = "物品名称字体大小",
	frame_alpha = "拾取框透明度",
	frame_alpha_high = "不透明",
	frame_alpha_low = "透明",
	frame_color_backdrop = "拾取框背景颜色",
	frame_color_border = "拾取框边框颜色",
	frame_color_gradient = "拾取框渐变颜色",
	frame_draggable = "可拖动更改拾取框位置",
	frame_scale = "拾取框缩放",
	frame_scale_high = "大",
	frame_scale_low = "小",
	frame_snap = "鼠标位置打开拾取框",
	frame_snap_offset_x = "水平偏移",
	frame_snap_offset_y = "垂直偏移",
	frame_width = "拾取框宽度",
	frame_width_automatic = "自动调整拾取框宽度",
	linkall_channel = "默认发送物品链接到频道",
	linkall_threshold = "发送链接的物品品质最低为",
	loot_alpha = "物品单元格透明度",
	loot_alpha_high = "不透明",
	loot_alpha_low = "透明",
	loot_collapse = "重复物品合并显示",
	loot_color_backdrop = "物品单元格背景颜色",
	loot_color_border = "物品单元格边框颜色",
	loot_color_gradient = "物品单元格渐变颜色",
	loot_color_info = "物品信息字体颜色",
	loot_highlight = "高亮鼠标指向的物品",
	loot_texts_bind = "显示物品绑定类型",
	loot_texts_info = "显示物品详细信息(部位/类型等)",
	quality_color_frame = "根据最高物品品质着色拾取框边框",
	quality_color_loot = "根据物品品质着色物品单元格边框",
	skin = "外观",
	skin_default = "XLoot: 默认",
	skin_legacy = "XLoot: 经典",
}

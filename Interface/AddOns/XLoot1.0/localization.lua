...
locales.zhCN["bind_on_equip_short"] = "装备绑定" -- Needs review
locales.zhCN["bind_on_pickup_short"] = "拾取绑定" -- Needs review
locales.zhCN["bind_on_use_short"] = "使用绑定" -- Needs review
locales.zhCN["button_close"] = "关闭" -- Needs review
locales.zhCN["button_link"] = "链接" -- Needs review
locales.zhCN["linkall_threshold_missed"] = "没有物品达到你的最低品质限制" -- Needs review
locales.zhCN.config = {
	...
	frame_color_gradient = "框架渐变颜色", -- Needs review
	frame_draggable = "拾取框可被拖动", -- Needs review
	frame_scale = "框架缩放",
	frame_scale_high = "大",
	frame_scale_low = "小",
	...
	frame_width = "框架宽度",
	frame_width_automatic = "自动调整框架宽度", -- Needs review
	linkall_channel = "默认发送物品链接到", -- Needs review
	linkall_threshold = "可发送链接的最低物品品质", -- Needs review
	loot_alpha = "格子透明度",
	loot_alpha_high = "不透明",
	loot_alpha_low = "透明",
	loot_collapse = "折叠拾取格子", -- Needs review
	loot_color_backdrop = "格子背景颜色", -- Needs review
	loot_color_border = "格子边框颜色", -- Needs review
	loot_color_gradient = "格子渐变颜色", -- Needs review
	loot_color_info = "物品信息字体颜色", -- Needs review
	loot_highlight = "高亮鼠标指向的格子", -- Needs review
	loot_texts_bind = "显示物品绑定类型", -- Needs review
	loot_texts_info = "显示物品信息(部位/类型等)", -- Needs review
	quality_color_frame = "根据最高物品品质着色框架边框", -- Needs review
	quality_color_loot = "根据物品品质着色格子边框", -- Needs review
	skin = "外观",

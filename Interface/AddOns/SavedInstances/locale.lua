...
La["Always show"] = "Mostrar siempre" -- Needs review
...
La["Hold Alt to show all data"] = "Pulse la tecla Alt para mostrar toda la información" -- Needs review
...
La["Show cooldown for characters to use battleground system"] = "Muestra el tiempo de reutilización de personajes para entrar en un campo de batalla." -- Needs review
La["Show cooldown for characters to use LFG dungeon system"] = "Muestra el tiempo de reutilización de personajes para utilizar el sistema BdG." -- Needs review
La["Show Expired"] = "Muestra expirados" -- Needs review
-- La["Show expired instance lockouts"] = ""
-- La["Show/Hide the SavedInstances tooltip"] = ""
La["Show history in Broker data feed"] = "Muestra la historia en el addon DataBroker" -- Needs review
...
La["Show when saved"] = "Mostrar cuando guardado" -- Needs review
...
La["Text"] = "Texto"
La["These are the instances that count towards the %i instances per hour account limit, and the time until they expire."] = "Estas instancias cuentan para el límite de %i por hora por cuenta, y expirará a la hora indicada." -- Needs review
La["Time Left"] = "Tiempo Restante"
La["Track"] = "Sigue" -- Needs review
La["Track Battleground Deserter cooldown"] = "Sigue el duración del perjuicio Desertor" -- Needs review
-- La["Track Daily Quests"] = ""

...
La["Show only current server"] = "Afficher uniquement le serveur actuel" -- Needs review
-- La["Show Random"] = ""
...
La["Track Battleground Deserter cooldown"] = "Suivre le cooldown \"Déserteur\" des Champs de Bataille" -- Needs review
...
La["World Boss"] = "Boss mondial" -- Needs review
...
La["Account"] = "Account" -- Needs review
...
La["Are you sure you want to reset the SavedInstances character database? Characters will be re-populated as you log into them."] = "Bist Du sicher, daß Du die SavedInstances Charakter-Datenbank zurücksetzen willst? Die Charaktere werden neu angelegt, wenn Du sie einloggst." -- Needs review
-- La["Attempt to recover completed daily quests for this character. Note this may recover some additional, linked daily quests that were not actually completed today."] = ""
...
La["|cffffff00Middle-click|r to show Blizzard's Raid Information"] = "|cffffff00Mittelklick|r , um die Blizzard-Schlachtszugsinfo anzuzeigen" -- Needs review
...
La["Color currency by cap"] = "Währung nach Limit einfärben" -- Needs review
...
La["Facets of Research"] = "Forschungsfacetten" -- Needs review
-- La["Farm Crops"] = ""
...
La["Note"] = "Notiz"
La["Opacity of the tooltip row highlighting"] = "Transparenz der Zeilenhervorhebung im Tooltip" -- Needs review
La["Open config"] = "Konfiguration öffnen" -- Needs review
La["Plant"] = "Pflanze" -- Needs review
...
La["Reset Characters"] = "Charaktere zurücksetzen" -- Needs review
La["Reverse ordering"] = "Umgekehrte Anordung"
La["Row Highlight"] = "Zeilenhervorhebung" -- Needs review
-- La["Seed"] = ""
-- La["Seeds"] = ""
...
La["Show only current server"] = "Nur diesen Server anzeigen" -- Needs review
La["Show Random"] = "Zufällig anzeigen" -- Needs review
La["Show random dungeon bonus reward"] = "Bonus-Belohnung für Zufalls-Dungeon anzeigen" -- Needs review
La["Show self always"] = "Sich selbst immer anzeigen" -- Needs review
La["Show self first"] = "Sich selbst zuerst anzeigen" -- Needs review
...
La["Sort by server"] = "Sortieren nach Server" -- Needs review
...
-- La["Track farm crops"] = ""
La["Track LFG dungeon cooldown"] = "Überwache Dungeonbrowser Abklingzeiten" -- Needs review
...
-- La["Trade Skill Cooldowns"] = ""
La["Transmute"] = "Transmutieren" -- Needs review
...
La["World Boss"] = "Weltboss" -- Needs review
...
La["Always show"] = "Всегда показывать"
...
La["Blizzard currently imposes a limit of 5 instances per hour per account. This feature will show you how many different instances you have entered in the last hour (if you have been in more than two). Once you have reached the limit, you will be shown how much time you must wait until you will be allowed to enter a new instance."] = "Blizzard в настоящее время устанавили лимит - 5 подземелий в час на аккаунт. Эта функция показывает вам, в скольких подземельях вы были в последний час (если вы были более чем в двух подземельях). Как только вы достигнете предела, вам покажут, сколько времени осталось, чтобы войти в новое подземелье." -- Needs review
La["Boss kill information is missing for this lockout.\\nThis is a Blizzard bug affecting certain old raids."] = "Отсутствует информация об убийстве босса для этого сохранения рейда.\\n Это является ошибкой компании Blizzard, затрагивающие некоторые старые рейды." -- Needs review
La["Categories"] = "Категории"
La["|cffffff00Left-click|r to detach tooltip"] = "|cffffff00Left-click|r Информация в отдельном окне"
La["|cffffff00Middle-click|r to show Blizzard's Raid Information"] = "Показать Blizzard's рейд информацию"
...
La["Color currency by cap"] = "Расцвечивать валюту в зависимости от достижения максимума" -- Needs review
...
La["Crops growing"] = "Растущие растения" -- Needs review
La["Crops harvested today"] = "Собранный сегодня урожай" -- Needs review
La["Crops planted today"] = "Посаженные сегодня растения" -- Needs review
La["Crops ready"] = "Готовые к сбору растения" -- Needs review
...
La["Facets of Research"] = "Грань исследования (ювелирное дело)" -- Needs review
-- La["Farm Crops"] = ""
...
La["Show name for a category when all displayed instances belong only to that category"] = "Показать имя для категории для всех отображаемых подземелий, принадлежащих только этой категории" -- Needs review
...
La["Show when saved"] = "Показывать когда сохранено"
...
La["Throw"] = "Выкинуть" -- Needs review
La["Time Left"] = "Обновится через" -- Needs review
...
La["Track farm crops"] = "Отображать посадки на ферме" -- Needs review
...
La["Track trade skill cooldowns"] = "Отслеживать восстановление профессиональных способностей." -- Needs review
La["Track Weekly Quests"] = "Отслеживать Еженедельные задания"
La["Trade Skill Cooldowns"] = "Восстановление способностей профессий." -- Needs review
La["Transmute"] = "Трансмутация (алхимия)" -- Needs review
La["Type"] = "Тип"
La["Use class color"] = "Цвет класса"
La["Warning: You've entered about %i instances recently and are approaching the %i instance per hour limit for your account. More instances should be available in %s."] = "Внимание: В последние время вы посетили %i подземелий и %i подземелий могут привести к ограничению для посещений подземелий в час для вашего аккаунта. В настоящий момент для вас доступны %s подземелий."
...
La["Account"] = "Cuenta" -- Needs review
La["Alternating columns are colored differently"] = "Columnas alternadas son de diferentes colores"
La["Always show"] = "Mostrar siempre"
La["Always show new instances"] = "Siempre mostrar nuevas instancias"
La["Are you sure you want to reset the SavedInstances character database? Characters will be re-populated as you log into them."] = "¿Seguro que quieres reiniciar la base de datos de personajes de SavedInstances? Los personajes se llenarán de nuevo cuando entres con ellos." -- Needs review
-- La["Attempt to recover completed daily quests for this character. Note this may recover some additional, linked daily quests that were not actually completed today."] = ""
La["Bind a key to toggle the SavedInstances tooltip"] = "Asignar una tecla para mostrar/ocultar la descripción SavedInstances"
La["Blizzard currently imposes a limit of 5 instances per hour per account. This feature will show you how many different instances you have entered in the last hour (if you have been in more than two). Once you have reached the limit, you will be shown how much time you must wait until you will be allowed to enter a new instance."] = "Blizzard impone un límite de 5 instancias por hora por cuenta. Esta función muestra el número de instancias diferentes que has entrado en la última hora. Cuando se llega al límite, se mostrará el tiempo que debe esperar antes de entrar en una nueva instancia."
La["Boss kill information is missing for this lockout.\\nThis is a Blizzard bug affecting certain old raids."] = "Falta información de " -- Needs review
La["Categories"] = "Categorías"
La["|cffffff00Left-click|r to detach tooltip"] = "|cffffff00Clic|r para separar la descripción"
La["|cffffff00Middle-click|r to show Blizzard's Raid Information"] = "|cffffff00Clic medio|r para mostrar el Info de banda"
La["|cffffff00Right-click|r to configure SavedInstances"] = "|cffffff00Click-Derecho|r para configurar SavedInstances"
...
La["Character details"] = "Detalles del personaje"
La["Characters"] = "Personajes"
La["Color currency by cap"] = "Colorea moneda por límite" -- Needs review
La["Columns are colored according to the characters class"] = "Las columnas se colorean según las clases de los personajes"
La["Columns are the same color as the whole tooltip"] = "Color las columnas del mismo color como la descripción entera."
La["Completed encounters"] = "Encuentros terminados"
-- La["Crops growing"] = ""
...
La["Expired Lockout - Can be extended"] = "Registro expirado - puede extenderse"
La["Extended Lockout - Not yet saved"] = "Registro extendido - no se ha guardado"
La["Facets of Research"] = "Facetas de investigación" -- Needs review
-- La["Farm Crops"] = ""
La["General settings"] = "Opciones generales"
La["Hold Alt to show all data"] = "Pulse la tecla Alt para mostrar toda la información"
La["Hover mouse on indicator for details"] = "Coloca el cursor sobre el indicador para más detalles"
...
La["Recent instance activity"] = "Actividad reciente de instancias"
La["Recent Instances"] = "Instancias recientes"
La["Recover Dailies"] = "Recuperar Diarias" -- Needs review
La["Report instance resets to group"] = "Informar de reinicializaciones de instancias al grupo"
La["Reset Characters"] = "Reinicializar Personajes" -- Needs review
La["Reverse ordering"] = "Invertir orden"
La["Row Highlight"] = "Resalta de fila"
-- La["Seed"] = ""
-- La["Seeds"] = ""
...
La["Show name for a category when all displayed instances belong only to that category"] = "Muestra el nombre de la categoría cuando todas las instancias que se muestran son de la misma categoría"
La["Show only current server"] = "Mostrar sólo el reino actual"
La["Show Random"] = "Muestra aleatoria" -- Needs review
La["Show random dungeon bonus reward"] = "Muestra recompensa entra en mazmorra aleatoria" -- Needs review
La["Show self always"] = "Siempre mostrar sí mismo"
La["Show self first"] = "Mostrar sí mismo primero"
La["Show the SavedInstances minimap button"] = "Mostrar el botón del minimapa de SavedInstances"
La["Show tooltip hints"] = "Mostrar consejos en descripciones"
...
La["Track random daily dungeon"] = "Seguir la mazmorra diaria aleatoria"
La["Track the instance IDs saved against your characters"] = "Sigue los IDs de las instancias a las que se guardan tus personajes"
La["Track trade skill cooldowns"] = "Seguir cooldowns de profesiones" -- Needs review
La["Track Weekly Quests"] = "Seguir misiones semanales"
La["Trade Skill Cooldowns"] = "Cooldowns de profesiones" -- Needs review
La["Transmute"] = "Transmutar" -- Needs review
La["Type"] = "Tipo"
La["Use class color"] = "Usar color de clase"
La["Warning: You've entered about %i instances recently and are approaching the %i instance per hour limit for your account. More instances should be available in %s."] = "Advertencia: Has entrado en %i instancias recientemente, y estás acercando al límite de %i instancias por hora para tu cuenta. Más instancias estarán disponibles después de %s."
La["Weekly Quests"] = "Misiones semanales"

...
rallachiverepl7				= "发现超过10个以上的成就（|cff00ff00%s|r）。在插件选项窗口中列出全部的可用成就（/rach - 区域列表）"
...
ralldefaulttactic3			= "描述：有时首领会对50码范围内的敌人造成伤害。每个受到该伤害的敌人都会使首领堆叠1层'吞噬'。\n战术：全力输出首领。"
...
ralldefaulttactic7			= "你必须打断所有施放的'变形'，施法时间会随着他的血量降低而加快。"
ralldefaulttactic8			= "为了获得野性残渣的减益效果，你需要被伊克正面锥形范围的技能击中：伊克的唾液。在那之后在没有死亡的情况下杀死最后的首领。"
ralldefaulttactic9			= "事实上，穿刺法术不会对威胁值最高的目标施放所以你可能需要2个坦克。所有队伍玩家都受到穿刺之后击杀首领。"
ralldefaulttactic10			= "首领在50%开始召唤软泥并在25%停止。等待那些小软泥变成你需要杀死的那些铁淤泥。"
ralldefaulttactic11			= "永冻每2-3秒堆叠一次。你可以使用的萨隆邪铁来阻挡首领的视线或者驱散他或者非常迅速的全力输出首领。"
...
ralldefaulttactic18			= "描述：第二个首领是随即的，它将会是银色神官帕尔崔丝或纯洁者耶德瑞克。帕尔崔丝在战斗中召唤的只是25个回忆中的1个。"
...
ralldefaulttactic20			= "如果他开始施放爆炸杀死食尸鬼或者风筝走首领。"
ralldefaulttactic21			= "'冰霜之墓' - 将目标困在寒冰障壁中。只要杀死首领而不用击碎冰霜墓穴，首领将会对随机玩家施放。"
...
ralldefaulttactic25			= "他们正尝试与首领合并的同时迅速杀死水泡。"
...
ralldefaulttactic34			= "首领将周期性的下潜（只有当他>35%血量时）并产生无法避免的虫群甲虫。刷新的虫群甲虫使用尽可能多的坦克同时坦克他们。没有范围技能，没有宠物，没有任何形式的溅射伤害。当越来越多的虫群甲虫刷新出来，请保持这些虫群甲虫活着通过第二次下潜。当第三次下潜时，所有小组聚集起来后使用群体伤害技能杀死他们。在第三次下潜期间你会有30秒的时间来杀死他们在墙壁附近生成的更多数量的虫群甲虫。你不用杀死首领来取得成就。"
...
ralldefaulttactic44			= "首领会随机在一个玩家身上施放疾病。不要驱散它，并且当它消失时，它会生成一个小软泥。尽量保持小软泥怪远离其他所有的小软泥怪。如果两个小软泥彼此靠近，它们将融合为一个大软泥。如果它融合了超过5个小软泥怪那么大软泥怪将会爆炸并且成就失败。所以请快速杀死首领并确保不合并小软泥怪。"
...
ralldefaulttactic56			= "使用单体目标伤害技能攻击（避免DOT效果）并把所有的黑暗符文守护者削减至不少于15000血量。地面阶段结束之前面对锋鳞，他将会直接在他面前的区域使用烈焰龙息。所有的统计数字不会重置。"
ralldefaulttactic57			= "在2次地面阶段内首领血量到达50%。"
ralldefaulttactic58			= "成就的描述不是正确的，很难理解是什么使他失败的。"
ralldefaulttactic59			= "在普通难度中请不要让任何XS-013废料机器人靠近XT-002拆解者并获得治疗。每隔25%血量，这些机器人会在心脏暴露阶段时产生。他们无视仇恨并不断朝着拆解者移动。废料机器人可以被减速和定身。"
...
ralldefaulttactic61			= "要求玩家当钢铁议会最后一个首领被杀害时受到铁靴烈酒效果的影响。铁靴烈酒可以在风暴群山的奥鲁特·埃雷古（部落）或洛尔克·锐须（联盟）处购买。"
...
ralldefaulttactic69			= "不允许任何一个团队成员堆叠刺骨之寒超过2层以上的情况下杀死霍迪尔。随着时间的推移整个团队堆叠刺骨之寒的层数在增加，并且随着时间的推移每堆叠一层都会造成伤害。移动和靠近参战法师召唤的温暖的火焰会降低堆叠的层数。近距离的冻结可以群体驱散并且可以通过移动来清除堆叠的层数避免快速冻结时变得更难以应对。"
...
ralldefaulttactic75			= "整个团队必须避开来自第1第4阶段的感应地雷，第2第4阶段的火箭打击和第3阶段的炸弹机器人爆炸。这个成就可以通过累计完成，因此请避开所有的炸弹机器人将那个条件完成并考虑下周团队侧重于感应地雷或火箭打击。"

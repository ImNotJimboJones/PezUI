...
L["D"] = true
L["Decreases: %s by |cffff7979%d|r"] = true
L["E"] = true
...
L["In Progress"] = true
L["Increases: %s by |cff00ff00%d|r"] = true
...
L["Choose which classes you wish to show along with non-class specific quests."] = true
L["Choose which races you wish to show along with non-race specific quests."] = true
L["Class Filter"] = true
...
L["Show quests for specific class"] = true
L["Show quests for specific faction"] = true
L["Show quests for specific race"] = true
L["Shows %s Only Quests"] = true
...
-- zonemenu.lua
L["Ahn'Qiraj War"] = true
L["Alchemy"] = true
L["All"] = true
L["Archaeology"] = true
L["Battlegrounds"] = true
L["Blackmaw Hold"] = true
...
L["Professions"] = true
L["Raids"] = true
L["Redridge Canyons"] = true
L["Reputation"] = true
L["Ruins of Uldum"] = true
L["Skettis"] = true

...
function EnergyWatchUI.CreateConfigMenu()
	...
	local barAlphaSlider = EnergyWatchUI.CreateSlider("BarAlphaSlider", appearanceConfigPanel, "barAlpha", EnergyWatchUI.BarAlphaSliderChanged, 0.0, 1.0, "0.0", "1.0", 0.01, "OptionsSliderTemplate")
	...
	local barHeightSlider = EnergyWatchUI.CreateSlider("barHeightSlider", appearanceConfigPanel, "barHeight", EnergyWatchUI.BarHeightSliderChanged, 25, 50, "25", "50", 1, "OptionsSliderTemplate")
	...
	--local barScaleSlider = EnergyWatchUI.CreateSlider("BarScaleSlider", appearanceConfigPanel, "barScale", EnergyWatchUI.BarScaleSliderChanged, 0.25, 3.0, "0.25", "3.0", 0.01, "OptionsSliderTemplate")
	...
	local barWidthSlider = EnergyWatchUI.CreateSlider("barWidthSlider", appearanceConfigPanel, "barWidth", EnergyWatchUI.BarWidthSliderChanged, 100, 300, "100", "300", 1, "OptionsSliderTemplate")
	...
	local barFontSizeSlider = EnergyWatchUI.CreateSlider("barFontSlider", appearanceConfigPanel, "barFontSize", EnergyWatchUI.BarFontSizeSliderChanged, 4, 24, "4", "24", 1, "OptionsSliderTemplate")
	...
	barFontDesc:SetPoint('TOPLEFT', barFontSizeDesc, 'TOPLEFT', 175, 0)
	...
	barTextureDesc:SetPoint('TOPLEFT', barWidthDesc, 'TOPLEFT', 175, 0)
...
function EnergyWatchUI.TextEditBoxChanged(self, isUserInput)
	if isUserInput then
		--print("Caught change, changing " .. self.configKey)
...
function EnergyWatchUI.BarWidthSliderChanged(self, value)
	...
	local barWidth = value
	EnergyWatchBar:SetWidth(barWidth)
	EnergyWatchBarBackground:SetWidth(barWidth + EnergyWatchUI.SizeOffsets.barBgWidth)
	EnergyWatchBarBorder:SetWidth(EnergyWatchBarBackground:GetWidth() * EnergyWatchUI.ScaleRatios.barBorderWidth)
	EnergyWatchText:SetWidth(barWidth + EnergyWatchUI.SizeOffsets.barTextWidth)
	EnergyWatchStatusBar:SetWidth(barWidth + EnergyWatchUI.SizeOffsets.barStatusWidth)
end

function EnergyWatchUI.BarHeightSliderChanged(self, value)
	EnergyWatchUI.SliderChanged(self, value)

	local barHeight = value
	EnergyWatchBar:SetHeight(barHeight)
	EnergyWatchBarBackground:SetHeight(barHeight + EnergyWatchUI.SizeOffsets.barBgHeight)
	EnergyWatchBarBorder:SetHeight(EnergyWatchBarBackground:GetHeight() * EnergyWatchUI.ScaleRatios.barBorderHeight)
	EnergyWatchText:SetHeight(barHeight + EnergyWatchUI.SizeOffsets.barTextHeight)
	EnergyWatchStatusBar:SetHeight(barHeight + EnergyWatchUI.SizeOffsets.barStatusHeight)
end
...
function EnergyWatchUI.CreateSlider(name, parent, configKey, onValueChangedFunc, minVal, maxVal, lowText, highText, valStep, template)
	...
	slider:SetScript("OnValueChanged", onValueChangedFunc)

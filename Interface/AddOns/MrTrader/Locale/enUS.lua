...
L["Undock Window"] = true
L["Will let the user place the Tradeskill Window anywhere."] = true
...
L["Clear Search"] = true
L["Loading"] = true
L["Show Filter List"] = true
L["Hide Filter List"] = true

-- Tradeskill Window Sort Strings
L["Sort By: %1$s %2$s"] = true
L["%1$s %2$s"] = true
L["Ascending"] = true
L["Descending"] = true
...
-- Tradeskill Window Default Plugins
L["Tools and Cooldown"] = true
L["Tools"] = true
L["%s more"] = true
L["Skill Ups"] = true

-- Tradeskill Profit Plugin
L["Profit Estimate"] = true
L["Show Materials Cost"] = true
L["Will show the cost of materials along with the estimate."] = true
end
...
L["%dg %ds %dc"] = "%dз %dс %dм"
L["%s data not found. Please log on this character once to record it."] = "Данные %s не найдены. Пожалуйста, зайдите за данного персонажа для их записи."
...
L["<%s>'s guild bank has not purchased any guild bank tabs."] = "<%s> не купил не одного раздела в гильд банке."
...
L["Check to show characters from the opposite faction (includes BankItems tooltips)."] = "Просмотр персонажей обоих фракций (добавляет информацию в BankItems подсказки)."
...
L["Note - Blizzard frames doesn't like it if your scale isn't 100% when using this option."] = "Заметка - Открытие окна банка Blizzard при использовании данной опции не рекомендуется, если масштаб 100% не установлен."

...
self_buffs.WARLOCK = {
	[116202] = mop_500 or nil, -- Aura of the Elements
	[116198] = mop_500 or nil, -- Aura of Enfeeblement
	[54274]  = not mop_500 or nil, -- Backdraft
	[117828] = mop_500 or nil, -- Backdraft
	[34936]  = true, -- Backlash
	[114168] = mop_500 or nil, -- Dark Apotheosis
	[113858] = mop_500 or nil, -- Dark Soul: Instability
	[113861] = mop_500 or nil, -- Dark Soul: Knowledge
	[113860] = mop_500 or nil, -- Dark Soul: Misery
	[63156]  = not mop_500 or nil, -- Decimation
	[687]    = not mop_500 or nil, -- Demon Armor
...
enemy_debuffs.WARLOCK = {
	...
	[710]    = true, -- Banish
	[91986]  = not mop_500 or nil, -- Burning Embers
	[124915] = mop_500 or nil, -- Chaos Wave
	[17962]  = mop_500 or nil, -- Conflagrate
	[172]    = true, -- Corruption
	[89]     = true, -- Cripple
	...
	[118093] = mop_500 or nil, -- Disarm (Voidwalker)
	[603]    = true, -- Doom
	[689]    = true, -- Drain Life
	...
	[85547]  = not mop_500 or nil, -- Jinx
	[103103] = mop_500 or nil, -- Malefic Grasp
	...
	[47960]  = mop_500 or nil, -- Shadowflame
	...
	[47960]  = not mop_500 or nil, -- Shadowflame
...
friend_buffs.WARRIOR = {
	...
	[114207] = mop_500 or nil, -- Skull Banner TODO: Verify
...
self_buffs.WARRIOR = {
	...
	[118038] = mop_500 or nil, -- Die by the Sword
	[12880]  = true, -- Enrage
	[55694]	 = true, -- Enraged Regeneration
	[12968]  = true, -- Flurry
	[115945] = mop_500 or nil, -- Glyph of Hamstring
	[115940] = mop_500 or nil, -- Glyph of Overpower
	[12975]  = true, -- Last Stand
	[85739]  = true, -- Meat Cleaver
	[58281]  = mop_500 or nil, -- Mighty Victory (Glyph of)
	[114192] = mop_500 or nil, -- Mocking Banner TODO: Verify
	[9347]   = mop_500 or nil, -- Mortal Strike (Glyph of)
	[115317] = mop_500 or nil, -- Raging Wind
	[8285]   = true, -- Rampage
	[1719]   = true, -- Recklessness
	[20230]  = not mop_500 or nil, -- Retaliation
	[15604]  = true, -- Second Wind
	[112048] = mop_500 or nil, -- Shield Barrier
	...
	[46916]  = true, -- Slam!
	[122510] = mop_500 or nil, -- Ultimatum
}
...
enemy_debuffs.WARRIOR = {
	[23690]  = mop_500 or nil, -- Bloodcurdling Shout (Glyph of)
	...
	[115768] = mop_500 or nil, -- Deep Wounds (Blood and Thunder)
	[114203] = mop_500 or nil, -- Demoralizing Banner TODO: Verify
	...
	[9347]   = not mop_500 or nil, -- Mortal Strike
	...
	[7386]   = not mop_500 or nil, -- Sunder Armor
	[355]    = true, -- Taunt
	[6343]   = not mop_500 or nil, -- Thunder Clap
	[105771] = mop_500 or nil, -- Warbringer

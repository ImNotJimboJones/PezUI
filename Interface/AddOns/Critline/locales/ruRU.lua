...
L["pet"] = "питомец"
L["Pet"] = "Питомец"
L["Plays a sound on a new record."] = "Воспроизводить звук при новом рекорде."
...
L["%s added to aura filter."] = "%s добавлен в фильтр аур"
...
L["%s is already in aura filter."] = "%s уже в фильтре аур"
...
L["%s removed from aura filter."] = "%s удален из фильтра аур"

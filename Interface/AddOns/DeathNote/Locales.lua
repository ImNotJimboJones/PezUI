...
if L then
L["All friendly players, including those not in your group"] = "당신의 그룹에 속하지 않은 모든 우호적인 플레이어" -- Needs review
L["Amount"] = "양" -- Needs review
L["Announce"] = "알림" -- Needs review
L["Announce deaths"] = "죽음 알림" -- Needs review
L["Announce deaths with an unknown cause"] = "알 수 없는 이유로 인한 죽음도 알립니다" -- Needs review
L["Announces/10 seconds limit"] = "알림/10 초 동안 보여질 알림 수" -- Needs review
L["Auras"] = "오라" -- Needs review
L["Bar"] = "바" -- Needs review
L["Battleground"] = "전장" -- Needs review
L["<Break>"] = "<사라짐>" -- Needs review
L["Buff fades"] = "버프 사라짐" -- Needs review
L["Buff gains"] = "버프 얻음" -- Needs review
L["|cFFEDA55FClick|r to open Death Note. |cFFEDA55FRight-Click|r to show options. |cFFEDA55FShift-Click|r to optimize data. |cFFEDA55FCtrl-Click|r to reset data."] = "|cFFEDA55F클릭|r Death Note 열기. |cFFEDA55F우-클릭|r 옵션 열기. |cFFEDA55F쉬프트-클릭|r 데이터 최적화. |cFFEDA55F컨트롤-클릭|r 데이터 초기화." -- Needs review
L["Channel"] = "채널" -- Needs review
L["Chat frame"] = "대화창" -- Needs review
L["Check the units you are interested in. Data for the units not filtered is discarded."] = "관심있는 유닛에 체크하세요. 체크하지 않은 유닛의 데이터는 수집하지 않습니다." -- Needs review
L["Combat log lines"] = "전투 로그 라인" -- Needs review
L["Compact"] = "간편화" -- Needs review
L["Consolidate consecutive auras"] = "연이은 오라 통합" -- Needs review
L["Consolidate consecutive heals"] = "연이은 치유 통합" -- Needs review
L["Consolidate consecutive hits"] = "연이은 공격 통합" -- Needs review
L["Damage"] = "데미지" -- Needs review
L["Data capture"] = "데이터 수집" -- Needs review
L["Data has been reset"] = "데이터 초기화됨" -- Needs review
L["Data optimization done in %.02f ms"] = "데이터 최적화가 %.02f ms 안에 완료됩니다." -- Needs review
L["Death"] = "죽음" -- Needs review
L["Death Note"] = true -- Needs review
L["Death Note: Death report for %s at %s"] = "Death Note: %s 에서 %s의 죽음 보고" -- Needs review
L["Debuff fades"] = "디버프 사라짐" -- Needs review
L["Debuff gains"] = "디버프 얻음" -- Needs review
L["Decrease scale"] = "크기 줄이기" -- Needs review
...
활성화하면 SavedVariables 파일 용량이 커지고 로그인/로그아웃하거나 UI 리로드할때 시간이 더 오래걸립니다.]=] -- Needs review
L["Enemy NPCs"] = "적대적 NPC" -- Needs review
L["Enemy players"] = "적 플레이어" -- Needs review
L[ [=[Enter one or more sources, separated by commas.
Ctrl+Click on a source column to add that source.]=] ] = [=[하나 이상의 소스를 입력하세요, 콤마로 구분.
소스 열을 컨트롤+클릭하면 소스가 추가됩니다.]=] -- Needs review
L[ [=[Enter one or more spells, separated by commas.
Ctrl+Click on a spell column to add that spell.]=] ] = [=[하나 이상의 주문을 입력하세요, 콤마로 구분.
주문 열을 컨트롤+클릭하면 주문이 추가됩니다.]=] -- Needs review
L["Filters"] = "필터" -- Needs review
L["Formatted"] = "형식 맞추기" -- Needs review
L["Formatted style options"] = "형식 스타일 옵션" -- Needs review
L["Friendly NPCs"] = "우호적인 NPC" -- Needs review
L["Friendly players"] = "우호적인 플레이어" -- Needs review
L["Group (party or raid)"] = "그룹 (파티나 공격대)" -- Needs review
L["Group players"] = "그룹 플레이어" -- Needs review
L["Guild"] = "길드" -- Needs review
L["Healing"] = "치유" -- Needs review
L["Health format"] = "체력 형식" -- Needs review
L["Hide misses"] = "빗나감 숨기기" -- Needs review
L["Highlight survival cooldowns"] = "생존기 지속시간 강조" -- Needs review
L["HP"] = true -- Needs review
L["HP %"] = true -- Needs review
L["HP/HPMax"] = true -- Needs review
L["<-%i buffs>"] = "<-%i 버프>" -- Needs review
L["<+%i buffs>"] = "<+%i 버프>" -- Needs review
L["%i deaths"] = "%i 죽음" -- Needs review
L["<-%i debuffs>"] = "<-%i 디버프>" -- Needs review
L["<+%i debuffs>"] = "<+%i 디버프>" -- Needs review
L["%i more deaths were not announced"] = "%i 개의 죽음을 알리지 않음" -- Needs review
L["(%i more lines not shown)"] = "(%i 개의 줄이 숨겨짐)" -- Needs review
L["Include amount resisted/blocked/absorbed"] = "저항/막음/흡수량 포함" -- Needs review
L["Include damage"] = "데미지 포함" -- Needs review
L["Include hit type (critical, crushing, etc)"] = "공격 타입 포함 (치명타, 강타 등등)" -- Needs review
L["Include overkill"] = "초과량 포함" -- Needs review
L["Increase scale"] = "크기 늘리기" -- Needs review
L["<Interrupt>"] = "<차단>" -- Needs review
L["Keep data between sessions"] = "세션간 데이터 유지하기" -- Needs review
L["Limiting report to %i lines"] = "보고할 갯수를 %i 줄로 제한합니다" -- Needs review
L["Maximum number of deaths"] = "데이터를 유지할 죽음의 최대 갯수" -- Needs review
L["Miss"] = "빗나감" -- Needs review
L["Name"] = "이름" -- Needs review
L["None"] = "없음" -- Needs review
L["Officer"] = "관리자" -- Needs review
L["Options"] = "옵션" -- Needs review
L["Other pets"] = "기타 소환수" -- Needs review
L["Others"] = "기타" -- Needs review
L["Output channel"] = "출력 채널" -- Needs review
L["Party"] = "파티" -- Needs review
L["Party and raid members, including yourself"] = "당신을 포함한 파티와 공격대원들" -- Needs review
L["Raid"] = "공격대" -- Needs review
L["Raid Warning"] = "공격대 경보" -- Needs review
L["Real time"] = "실시간" -- Needs review
L["<Refresh>"] = "<갱신>" -- Needs review
L["Report style"] = "보고 형식" -- Needs review
L["Reset"] = "초기화" -- Needs review
L["Reset data"] = "데이터 초기화" -- Needs review
L["Say"] = "일반대화" -- Needs review
L["Scale: %i%%"] = "크기: %i%%" -- Needs review
L["Seconds from death"] = "죽음으로 부터 시간 표시 (초)" -- Needs review
L["Seconds to keep before each death (for other units)"] = "죽기 직전 상황을 기록할 시간 (다른 개체)" -- Needs review
L["Seconds to keep before each death (for the unit killed)"] = "죽기 직전 상황을 기록할 시간 (죽은 개체)" -- Needs review
L["Send report from this line"] = "이 라인 보고하기" -- Needs review
L["Setting scale to %i%%"] = "크기를 %i%%로 맞추기" -- Needs review
L["Show Death Note"] = "Death Note 보이기" -- Needs review
L["Show target deaths"] = "대상의 죽음로그 보기" -- Needs review
L["+%s (%i heals) (%s)"] = "+%s (%i 치유) (%s)" -- Needs review
L["-%s (%i hits) (%s)"] = "-%s (%i 타격) (%s)" -- Needs review
L["Sort deaths by"] = "죽음 정렬" -- Needs review
L["Source"] = "소스" -- Needs review
L["Source filter"] = "소스 필터" -- Needs review
L["(%s overkill)"] = "(%s 초과데미지)" -- Needs review
L["Spell"] = "주문" -- Needs review
L["Spell filter"] = "주문 필터" -- Needs review
L["%s|r has died of a heart attack"] = "%s|r 심장마비로 죽었습니다." -- Needs review
L["%s|r was killed by"] = "%s|r 죽음 : " -- Needs review
L["%s's|r %s"] = "%s의|r %s" -- Needs review
L["<Steal>"] = "<훔침>" -- Needs review
L["Survival cooldowns"] = "생존기 지속시간" -- Needs review
L["The effect of this filter depends on the other filters. For example, if you have the friendly players filter inactive, their pets deaths won't be recorded either, even with this filter activated."] = "이 필터의 효과는 다른 필터에 영향을 받습니다. 예를 들어, 우호적인 플레이어를 비활성화 했을 때는 그들의 소환수가 죽어도 기록하지 않지만, 이 필터를 활성화하면 소환수의 죽음을 기록합니다." -- Needs review
L["This data is used to display actions of other players when a death happened. Set this value to 0 unless you want to use this feature, as it can use a large amount of memory."] = "이 데이터는 죽음이 발생했을 때 다른 플레이어의 행동을 표시합니다. 값을 0으로 설정하면, 많은 양의 메모리를 사용합니다." -- Needs review
L["Threshold"] = "한계치" -- Needs review
L["Time"] = "시간" -- Needs review
L["Time format"] = "시간 형식" -- Needs review
L["Units filters"] = "유닛 필터" -- Needs review
L["Unknown"] = "알 수 없음" -- Needs review
L["Whisper"] = "귓속말" -- Needs review
L["Whisper target"] = "대상 귓속말" -- Needs review
L["Your pet"] = "당신의 소환수" -- Needs review
L["You were killed by"] = "당신 죽음 : " -- Needs review
...
L["Buff fades"] = "增益狀態消失"
L["Buff gains"] = "增益狀態獲得"
L["|cFFEDA55FClick|r to open Death Note. |cFFEDA55FRight-Click|r to show options. |cFFEDA55FShift-Click|r to optimize data. |cFFEDA55FCtrl-Click|r to reset data."] = "|cFFEDA55F點擊|r 開啟死亡記錄。 |cFFEDA55F右鍵-點擊|r 顯示選項。 |cFFEDA55FShift-點擊|r 資料優化。 |cFFEDA55FCtrl-點擊|r to 重設資料。" -- Needs review
L["Channel"] = "頻道"
L["Chat frame"] = "聊天視窗"
L["Check the units you are interested in. Data for the units not filtered is discarded."] = "檢查你感興趣的單位。 此單位未過濾的數據不會被丟棄。" -- Needs review
L["Combat log lines"] = "戰鬥紀錄" -- Needs review
L["Compact"] = "簡潔" -- Needs review
L["Consolidate consecutive auras"] = "合併連續光環" -- Needs review
L["Consolidate consecutive heals"] = "合併連續治療" -- Needs review
L["Consolidate consecutive hits"] = "合併連續命中"
L["Damage"] = "傷害"
L["Data capture"] = "資料收集" -- Needs review
L["Data has been reset"] = "資料已重設"
L["Data optimization done in %.02f ms"] = "資料優化在 %.02f ms內完成"
L["Death"] = "死亡"
L["Death Note"] = "死亡記錄" -- Needs review
L["Death Note: Death report for %s at %s"] = "死亡記錄：%s 的死亡報告於 %s" -- Needs review
L["Debuff fades"] = "減益狀態消失"
L["Debuff gains"] = "減益狀態獲得"
L["Decrease scale"] = "縮小比例" -- Needs review
L["<Dispel>"] = "<驅散>"
...
L["<-%i debuffs>"] = "<-%i 減益狀態>"
L["<+%i debuffs>"] = "<+%i 減益狀態>"
L["%i more deaths were not announced"] = "多於%i的死亡不會被通告" -- Needs review
L["(%i more lines not shown)"] = "(多於%i行不顯示)" -- Needs review
L["Include amount resisted/blocked/absorbed"] = "包含抵抗/格檔/吸收的數字" -- Needs review
L["Include damage"] = "包含傷害" -- Needs review
L["Include hit type (critical, crushing, etc)"] = "包含命中類型 (致命、碾壓 等)"
L["Include overkill"] = "包含過量傷害" -- Needs review
L["Increase scale"] = "放大比例" -- Needs review
L["<Interrupt>"] = "<斷法>"
L["Keep data between sessions"] = "保持數據在登出後" -- Needs review
...
L["Reset data"] = "重設資料"
L["Say"] = "說"
L["Scale: %i%%"] = "比例：%i%%" -- Needs review
L["Seconds from death"] = "秒內死亡"
L["Seconds to keep before each death (for other units)"] = "每個死前紀錄的秒數(其他單位)" -- Needs review
L["Seconds to keep before each death (for the unit killed)"] = "每個死前紀錄的秒數 (已死的單位)" -- Needs review
L["Send report from this line"] = "將這行發送報告"
L["Setting scale to %i%%"] = "設定比例為%i%%" -- Needs review
L["Show Death Note"] = "顯示死亡記錄" -- Needs review
L["Show target deaths"] = "顯示目標死亡"
L["+%s (%i heals) (%s)"] = "+%s (%i 治療) (%s)"
L["-%s (%i hits) (%s)"] = "-%s (%i 命中) (%s)"
L["Sort deaths by"] = "排列死亡由" -- Needs review
L["Source"] = "來源"
L["Source filter"] = "來源過濾器"
L["(%s overkill)"] = "(%s 過量傷害)" -- Needs review
L["Spell"] = "法術"
L["Spell filter"] = "法術過濾器"
L["%s|r has died of a heart attack"] = "%s|r 死於心臟病發" -- Needs review
L["%s|r was killed by"] = "%s|r 死於"
L["%s's|r %s"] = "%s的|r %s"
L["<Steal>"] = "<竊取>"
L["Survival cooldowns"] = "存活冷卻時間"
L["The effect of this filter depends on the other filters. For example, if you have the friendly players filter inactive, their pets deaths won't be recorded either, even with this filter activated."] = "這種過濾器的效果依賴於其他過濾器。例如，如果您的友方玩家過濾器未啟用，他們的寵物的死亡也不會被記錄，即使這個過濾器有啟用。" -- Needs review
L["This data is used to display actions of other players when a death happened. Set this value to 0 unless you want to use this feature, as it can use a large amount of memory."] = "這個數據是用來顯示其他玩家死亡時的行動。除非你想使用這個功能不然將此值設置為0，因為它會使用大量的記憶體。" -- Needs review
L["Threshold"] = "門閥" -- Needs review
L["Time"] = "時間"
L["Time format"] = "時間格式"
...
L["Your pet"] = "你的寵物"
L["You were killed by"] = "你死於" -- Needs review

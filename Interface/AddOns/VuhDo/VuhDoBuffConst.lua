...
VUHDO_CLASS_BUFFS = {
	...
	["SHAMAN"] = {
		...
		[VUHDO_SPELL_ID.BUFF_MANA_TIDE_TOTEM] = { -- 05
			{ VUHDO_SPELL_ID.BUFF_MANA_TIDE_TOTEM, VUHDO_BUFF_TARGET_TOTEM },
		},
		[VUHDO_SPELL_ID.BUFF_HEROISM] = { -- 06
			{ VUHDO_SPELL_ID.BUFF_HEROISM, VUHDO_BUFF_TARGET_OWN_GROUP },
		},
		[VUHDO_SPELL_ID.BUFF_BLOODLUST] = { -- 07
			{ VUHDO_SPELL_ID.BUFF_BLOODLUST, VUHDO_BUFF_TARGET_OWN_GROUP },
		},
		[VUHDO_SPELL_ID.BUFF_EARTH_SHIELD] ={ -- 08
	...
	["PALADIN"] = {
		[VUHDO_I18N_BUFFC_BLESSING] = {
			{ VUHDO_SPELL_ID.BUFF_BLESSING_OF_THE_KINGS, VUHDO_BUFF_TARGET_RAID, VUHDO_SPELL_ID.BUFF_MARK_OF_THE_WILD, VUHDO_SPELL_ID.BUFF_LEGACY_OF_THE_EMPEROR },
	...
	["DRUID"] = {
		[VUHDO_SPELL_ID.BUFF_MARK_OF_THE_WILD] = {
				{ VUHDO_SPELL_ID.BUFF_MARK_OF_THE_WILD, VUHDO_BUFF_TARGET_RAID, VUHDO_SPELL_ID.BUFF_BLESSING_OF_THE_KINGS, VUHDO_SPELL_ID.BUFF_LEGACY_OF_THE_EMPEROR },
		},
	},

	["WARLOCK"] = {
    [VUHDO_SPELL_ID.BUFF_DARK_INTENT] = { -- 2
			{ VUHDO_SPELL_ID.BUFF_DARK_INTENT, VUHDO_BUFF_TARGET_RAID },
  	},
    [VUHDO_SPELL_ID.BUFF_GRIMOIR_OF_SACRIFICE] = { -- 2
			{ VUHDO_SPELL_ID.BUFF_GRIMOIR_OF_SACRIFICE, VUHDO_BUFF_TARGET_SELF },
  	},
	},

	["MAGE"] = {
		[VUHDO_SPELL_ID.BUFF_ARCANE_BRILLIANCE] = { -- 1
		...
		[VUHDO_SPELL_ID.BUFF_ICE_BLOCK] = { -- 2

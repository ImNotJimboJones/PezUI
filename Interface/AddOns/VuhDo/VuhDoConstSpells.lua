...
VUHDO_SPELL_ID.BUFFC_FEAR_WARD         = "02" .. VUHDO_getSpellInfo(6346);
VUHDO_SPELL_ID.BUFFC_INNER_FIRE        = "03" .. VUHDO_getSpellInfo(588);
VUHDO_SPELL_ID.BUFFC_SHADOW_FIEND      = "04" .. VUHDO_getSpellInfo(34433);
VUHDO_SPELL_ID.BUFFC_POWER_INFUSION    = "05" .. VUHDO_getSpellInfo(10060);
VUHDO_SPELL_ID.BUFFC_VAMPIRIC_EMBRACE  = "06" .. VUHDO_getSpellInfo(15286);
VUHDO_SPELL_ID.BUFFC_LEVITATE          = "07" .. VUHDO_getSpellInfo(1706);
VUHDO_SPELL_ID.BUFFC_PAIN_SUPPRESSION  = "08" .. VUHDO_getSpellInfo(33206);
VUHDO_SPELL_ID.BUFFC_CHAKRA            = "09" .. VUHDO_getSpellInfo(126172); -- MOP?

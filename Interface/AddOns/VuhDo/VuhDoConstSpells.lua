...
VUHDO_SPELL_ID.BLESSED_HEALING = VUHDO_getSpellInfo(70772);
...
VUHDO_SPELL_ID.HOLY_WORD_CHASTISE = VUHDO_getSpellInfo(88625);
VUHDO_SPELL_ID.HOLY_WORD_SANCTUARY = VUHDO_getSpellInfo(88685);
VUHDO_SPELL_ID.HOLY_WORD_SERENITY = VUHDO_getSpellInfo(88684);
VUHDO_SPELL_ID.ICE_BARRIER = VUHDO_getSpellInfo(11426);
VUHDO_SPELL_ID.ILLUMINATED_HEALING = VUHDO_getSpellInfo(76669);
...
-- Priest
VUHDO_SPELL_ID.BUFFC_FORTITUDE         = "01" .. VUHDO_getSpellInfo(13864);
VUHDO_SPELL_ID.BUFFC_SHADOW_PROTECTION = "02" .. VUHDO_getSpellInfo(7244); -- MOP?

VUHDO_SPELL_ID.BUFFC_FEAR_WARD         = "03" .. VUHDO_getSpellInfo(6346);
VUHDO_SPELL_ID.BUFFC_INNER_FIRE        = "04" .. VUHDO_getSpellInfo(588);
VUHDO_SPELL_ID.BUFFC_SHADOW_FIEND      = "05" .. VUHDO_getSpellInfo(34433);
VUHDO_SPELL_ID.BUFFC_POWER_INFUSION    = "06" .. VUHDO_getSpellInfo(10060);
VUHDO_SPELL_ID.BUFFC_VAMPIRIC_EMBRACE  = "07" .. VUHDO_getSpellInfo(15286);
VUHDO_SPELL_ID.BUFFC_LEVITATE          = "08" .. VUHDO_getSpellInfo(1706);
VUHDO_SPELL_ID.BUFFC_PAIN_SUPPRESSION  = "09" .. VUHDO_getSpellInfo(33206);
VUHDO_SPELL_ID.BUFFC_CHAKRA            = "10" .. VUHDO_getSpellInfo(126172); -- MOP?

-- Shaman
VUHDO_SPELL_ID.BUFFC_HEROISM             = "05" .. VUHDO_getSpellInfo(32182);
VUHDO_SPELL_ID.BUFFC_BLOODLUST           = "06" .. VUHDO_getSpellInfo(2825)
VUHDO_SPELL_ID.BUFFC_EARTH_SHIELD        = "07" .. VUHDO_getSpellInfo(974);
VUHDO_SPELL_ID.BUFFC_MANA_TIDE_TOTEM     = "10" .. VUHDO_getSpellInfo(16190);
VUHDO_SPELL_ID.BUFFC_ANCESTRAL_SWIFTNESS = "11" .. VUHDO_getSpellInfo(16188);

-- Paladin
VUHDO_SPELL_ID.BUFFC_BEACON_OF_LIGHT = "03" .. VUHDO_getSpellInfo(53563);
VUHDO_SPELL_ID.BUFFC_RIGHTEOUS_FURY  = "04" .. VUHDO_getSpellInfo(25780);
VUHDO_SPELL_ID.BUFFC_INQUISITION     = "05" .. VUHDO_getSpellInfo(84963);

-- Druid
VUHDO_SPELL_ID.BUFFC_MARK_OF_THE_WILD = "01" .. VUHDO_getSpellInfo(1126);

-- Warlock
VUHDO_SPELL_ID.BUFFC_DARK_INTENT = "01" .. VUHDO_getSpellInfo(109773); -- MOP

-- Mage
VUHDO_SPELL_ID.BUFFC_ARCANE_BRILLIANCE = "01" .. VUHDO_getSpellInfo(23030);
VUHDO_SPELL_ID.BUFFC_ICE_BLOCK         = "02" .. VUHDO_getSpellInfo(45438);
VUHDO_SPELL_ID.BUFFC_COMBUSTION        = "04" .. VUHDO_getSpellInfo(11129);
VUHDO_SPELL_ID.BUFFC_SLOW_FALL         = "05" .. VUHDO_getSpellInfo(130);
VUHDO_SPELL_ID.BUFFC_INVISIBILITY      = "06" .. VUHDO_getSpellInfo(66);

-- Death Knights
VUHDO_SPELL_ID.BUFFC_HORN_OF_WINTER = "01" .. VUHDO_getSpellInfo(57330);
VUHDO_SPELL_ID.BUFFC_BONE_SHIELD    = "02" .. VUHDO_getSpellInfo(49222);
VUHDO_SPELL_ID.BUFFC_UNHOLY_FRENZY  = "04" .. VUHDO_getSpellInfo(49016);

-- Warriors
VUHDO_SPELL_ID.BUFFC_VIGILANCE = "02" .. VUHDO_getSpellInfo(114030); -- MOP

-- Hunter
VUHDO_SPELL_ID.BUFFC_TRUESHOT_AURA = "01" .. VUHDO_getSpellInfo(19506);

-- Rogue
VUHDO_SPELL_ID.BUFFC_TRICKS_OF_THE_TRADE = "01" .. VUHDO_getSpellInfo(57934);

--Monk
VUHDO_SPELL_ID.BUFFC_LEGACY_OF_THE_EMPEROR = "02" .. VUHDO_getSpellInfo(115921);
VUHDO_SPELL_ID.BUFFC_LEGACY_OF_THE_WHITE_TIGER = "03" .. VUHDO_getSpellInfo(116781);
...
VUHDO_SPELL_ID.BUFF_SHADOW_PROTECTION = VUHDO_getSpellInfo(7244); -- MOP?
...
--VUHDO_SPELL_ID.BUFF_ASPECT_OF_THE_WILD = VUHDO_getSpellInfo(20043); -- MOP
...
VUHDO_SPELL_ID.DEBUFF_ARCANE_BLAST = VUHDO_getSpellInfo(30451);

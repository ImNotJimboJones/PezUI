-- $Id: Atlas_WorldEvents-zhCN.lua 47 2013-02-17 12:14:13Z arith $
--[[
...
if AL then
	...
	AL["Lunar_Date"] = "1月27日～2月9日";
	AL["Midsummer Fire Festival"] = "仲夏节";
	AL["Midsummer_Date"] = "6月21日～7月4日";
	AL["Hallow's End"] = "万圣节";
	AL["Hallow_Date"] = "10月18日～10月31日";
	AL["Brewfest"] = "美酒节";
	AL["Brewfest_Date"] = "9月20日～10月15日";
	-- Darkmoon Faire

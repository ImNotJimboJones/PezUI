...
local MINOR_VERSION = 90000 + tonumber(("$Rev: 172 $"):match("%d+"))
...
elseif GAME_LOCALE == "frFR" then
	...
	["Best Friend"] = "Meilleur ami", -- Needs review
	...
	["Chee Chee"] = "Chii Chii", -- Needs review
	...
	["Farmer Fung"] = "Fermier Fung", -- Needs review
	["Fish Fellreed"] = "Marée Pelage de Roseau", -- Needs review
	["Forest Hozen"] = "Hozen des forêts", -- Needs review
	["Frenzyheart Tribe"] = "Tribu Frénécœur",
	Friend = "Ami", -- Needs review
	Friendly = "Amical",
	["Frostwolf Clan"] = "Clan Loup-de-givre",
	Gadgetzan = "Gadgetzan",
	["Gelkis Clan Centaur"] = "Centaures (Gelkis)",
	Gilneas = "Gilnéas",
	["Gina Mudclaw"] = "Gina Griffe de Tourbe", -- Needs review
	Gnomeregan = "Gnomeregan",
	["Gnomeregan Exiles"] = "Exilés de Gnomeregan",
	["Golden Lotus"] = "Lotus doré", -- Needs review
	-- ["Good Friend"] = "",
	["Guardians of Hyjal"] = "Gardiens d'Hyjal",
	Guild = "Guilde",
	["Haohan Mudclaw"] = "Haohan Griffe de Tourbe", -- Needs review
	["Hellscream's Reach"] = "Poing de Hurlenfer",
	Honored = "Honoré",
	["Honor Hold"] = "Bastion de l'Honneur",
	Horde = "Horde",
	["Horde Expedition"] = "Expédition de la Horde",
	["Huojin Pandaren"] = "Les pandarens huojin", -- Needs review
	["Hydraxian Waterlords"] = "Les Hydraxiens",
	Ironforge = "Forgefer",
	["Jogu the Drunk"] = "Jogu l’Ivrogne", -- Needs review
	...
	Neutral = "Neutre",
	["Ogri'la"] = "Ogri'la",
	["Old Hillpaw"] = "Vieux Patte des Hauts", -- Needs review
	["Order of the Cloud Serpent"] = "L’ordre du Serpent-nuage", -- Needs review
	Orgrimmar = "Orgrimmar",
	["Pearlfin Jinyu"] = "Jinyu de Nageperle", -- Needs review
	Ramkahen = "Ramkahen",
	Ratchet = "Cabestan",
	Ravenholdt = "Ravenholdt",
	Revered = "Révéré",
	["Shado-Pan"] = "Pandashan", -- Needs review
	["Shang Xi's Academy"] = "Académie de Shang Xi", -- Needs review
	...
	Stormwind = "Hurlevent",
	Stranger = "Etranger", -- Needs review
	Syndicate = "Syndicat",
	["The Aldor"] = "L'Aldor",
	["The Anglers"] = "Les Hameçonneurs", -- Needs review
	["The Ashen Verdict"] = "Le Verdict des cendres",
	["The August Celestials"] = "Les Astres vénérables", -- Needs review
	["The Black Prince"] = "Le prince noir", -- Needs review
	["The Brewmasters"] = "Les Maîtres brasseurs", -- Needs review
	...
	["The Klaxxi"] = "Les Klaxxi", -- Needs review
	["The League of Arathor"] = "La Ligue d'Arathor",
	["The Lorewalkers"] = "Les Chroniqueurs", -- Needs review
	...
	["The Tillers"] = "Les Laboureurs", -- Needs review
	...
	["Tina Mudclaw"] = "Tina Griffe de Tourbe", -- Needs review
	Tranquillien = "Tranquillien",
	["Tushui Pandaren"] = "Les pandarens tushui", -- Needs review

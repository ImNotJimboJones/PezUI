...
if (raminibutshowt) then PSFeamainadd_3_CheckButton11:SetChecked() else PSFeamainadd_3_CheckButton11:SetChecked(false) end
if (pseashowfailreas) then PSFeamainadd_3_CheckButton2:SetChecked() else PSFeamainadd_3_CheckButton2:SetChecked(false) end
if (pseashownewvervar) then PSFeamainadd_3_CheckButton3:SetChecked() else PSFeamainadd_3_CheckButton3:SetChecked(false) end
if (rasoundtoplay[1]==1) then PSFeamainadd_3_CheckButton4:SetChecked() else PSFeamainadd_3_CheckButton4:SetChecked(false) end
if (rasoundtoplay[2]==1) then PSFeamainadd_3_CheckButton5:SetChecked() else PSFeamainadd_3_CheckButton5:SetChecked(false) end
if (rasoundtoplay[3]==1) then PSFeamainadd_3_CheckButton6:SetChecked() else PSFeamainadd_3_CheckButton6:SetChecked(false) end
if (rasoundtoplay[6]==1) then PSFeamainadd_3_CheckButton7:SetChecked() else PSFeamainadd_3_CheckButton7:SetChecked(false) end
...
function PSFeavklshownames()
	if (PSFeamainadd_3_CheckButton2:GetChecked()) then
...
function PSFeavklshownewver()
	if (PSFeamainadd_3_CheckButton3:GetChecked()) then
...
if (PSFeamainadd_3_CheckButton11:GetChecked()) then
raminibutshowt=true
else
...
CreateFrame("Frame", "DropDownrasound1", PSFeamainadd_3, "UIDropDownMenuTemplate")
end
...
CreateFrame("Frame", "DropDownrasound2", PSFeamainadd_3, "UIDropDownMenuTemplate")
end
...
CreateFrame("Frame", "DropDownMenureportchra11", PSFeamainadd_3, "UIDropDownMenuTemplate")
end
...
CreateFrame("Frame", "DropDownMenureportchra12", PSFeamainadd_3, "UIDropDownMenuTemplate")
end

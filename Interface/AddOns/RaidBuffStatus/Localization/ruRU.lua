...
L["Blessing of Kings is not needed because you are grouped with a Druid."] = "Благословение королей не требуется, потому что в в группе есть Друид"
...
L["BoW"] = "BoW"
L["Buffers: "] = "Бафферы: "
L["Buffing Kings:"] = "Баффает Кинги:"
L["Buffing Might:"] = "Баффает Могущество:"
...
L["Int"] = "Инт"
-- L[" in their bags"] = ""
L["Invite auto-accepted from battle.net friend %s."] = "Приглашение автоматически принято от друга по battle.net %s"
L["Invite auto-accepted from friend %s."] = "Приглашение автоматически принято от друга %s"
L["Invite auto-accepted from guild member %s."] = "Приглашение автоматически принято от члена гильдии %s"
...
L["Missing or not working oRA or RBS: "] = "Не работает/отсутствует аддон oRA2: " -- Needs review
...
L["%s about to expire!"] = "%s - срок истекает!"
...
L["Spi"] = "Дух"
L["Sta"] = "Внс"
L["Stamina increased by 60"] = "выносливость повышены на 60"
L["Stamina increased by 90"] = "выносливость повышены на 90"
L["Str"] = "Сила"
...
L["Alive"] = "Живые"
L["Allow raiders to use level 80 WotLK flasks and elixirs"] = "Позволить рейдерам использовать настои и эликсиры 80-ого уровня из WotLK" -- Needs review
L["Alt-left click"] = "Alt+клик левой кнопкой"
L["Alt-right click"] = "Alt+клик правой кнопкой"
-- L["Always hide the Boss R Trash buttons"] = ""
L["Announce to raid warning when a Cauldron is prepared"] = "Сообщать рейду о приготовлении Котла Войны"
L["Announce to raid warning when a Feast is prepared"] = "Извещать рейд о приготовлении Рыбного пира." -- Needs review
...
L["Auto-accept invites"] = "Автоматически принимать приглашение в группу"
-- L["Auto-invite whispers"] = ""
L["Automatically accept invites from friends and guild members so you can go for a bio-break whilst waiting for a raid invite"] = "Автоматически принимать приглашение в группу от друзей и членов гильдии, так что вы сможете отойти от компа пока ждете приглашение в рейд"
L["Automatically accept invites from these"] = "Автоматически принимать приглашение от:"
...
L["Automatically whisper anyone missing flasks or elixirs when your Cauldron expire warnings appear"] = "Автоматически шептать игрокам без фласок или эликсиров при сообщении об исчезновении Котла Войны"
L["Automatically whisper anyone missing Well Fed when your Feast expire warnings appear"] = "Автоматически шептать всем, кто не поел, о том, что Пир скоро исчезнет"
-- L["Automation"] = ""
L["Background colour"] = "Цвет фона"
-- L["Bar positioning"] = ""
L["Battle.net friends"] = "Друзья по Battle.net "
L["Best - %s stamina"] = "Лучшая - %s выносливости"
L["Border colour"] = "Цвет краев"
L["Bosses only"] = "Bosses only"
-- L["Bottom"] = ""
-- L["Buff button sorting"] = ""
L["Buff Options scale"] = "Размер опций баффов"
L["Buff those missing buff"] = "Баффнуть"
L["Buff Wizard"] = "Мастер баффов" -- Needs review
L["Cauldron"] = "Котел Войны"
L["Cauldron auto whisper"] = "Авто-шепот о Котле Войны"
...
-- L["Consumables"] = ""
L["Core raid buffs"] = "Основные баффы рейда"
L["Ctrl-left click"] = "Ctrl+клик левой кнопкой"
L["Ctrl-right click"] = "Ctrl+правый клик"
L["Danielbarron broke Sheep on The Lich King with Hand of Reckoning"] = "Даниэльбаррон сбил овцу с Короля Лича своей Дланью возмездия"
...
L["Dashboard scale"] = "Масштаб панели управления"
...
L["Feast auto whisper"] = "Шептать о Пире"
L["Feasts"] = "Рыбный пир" -- Needs review
L["Food announce"] = "Извещение о еде" -- Needs review
L["Food raid warning announcement options for things like Feasts"] = "Извещение рейда в канал объявлений о еде такой как Рыбный пир." -- Needs review
L["Friends"] = "Друзья"
L["Good food only"] = "Только хорошая еда" -- Needs review
L["Good - %s stamina"] = "Хорошая - %s выносливости"
...
L["Non-tank Glamor broke Hex on The Lich King with Moonfire"] = "Не-танк Гламур сбил Сглаз с Короля Лича своим Лунным огнём"
...
-- L["One big group"] = ""
-- L["One group down"] = ""
L["Only allow food that is 90 Stamina and other stats.  I.e. only allow the top quality food with highest stats"] = "Позволять только еду, прибавляющую 90 к выносливости и какой-либо другой характеристике, т.е. только еду наилучшего качества с наивысшими характеристиками" -- Needs review
L["Only if all have it"] = "Только если это есть у всех"
L["Only me"] = "Только я"
L["Only show the buffs for which your class is responsible for.  This configuration can be used like a buff-bot where one simply right clicks on the buffs to cast them"] = "Показать только те баффы, которые относятся к вашему классу. В таком виде можно использовать как аддон для баффов - достаточно кликнуть правой кнопкой на нужном, чтобы бафнуть рейд."
L["Only show the core class raid buffs"] = "Показать только основные баффы классов"
...
L["Play a sound when one of your taunts fails due to resist"] = "Предупредить звуком, если ваш таунт промазал из-за резиста"
...
L["Poor - any food"] = "Для бомжей - любая еда."
...
L["Ranged DPS Garmann has died!"] = "РДД Гарманн умер!"
...
L["Required food quality"] = "Качество еды для рейдеров"
L["Require the Alt buton to be held down to move the dashboard window"] = "Требовать зажатие Alt для перемещения табло"
L["[RESIST] Danielbarron FAILED TO TAUNT their target (The Lich King) with Hand of Reckoning"] = "Danielbarron ПРОМАЗАЛ ТАУНТОМ по его цели (Король Лич) используя Длань возмездия"
...
L["Scale the Buff Options window"] = "Размер окошка опций баффов"
L["Scale the dashboard window"] = "Масштаб окна панели управления"
...
L["Select which level of food quality you require for the raiders to be considered 'Well Fed'"] = "Выберите уровень качества еды для рейдеров"
-- L["Self buffs"] = ""
L["Set how many seconds between dashboard raid scan updates"] = "Назначить количество секунд между сканированиями рейда"
L["Set N - the number of people missing a buff considered to be \"MANY\""] = "Назначить N - количество игроков с отсутствующим баффом, расценивающееся, как \"МНОГО\". This also affects reagent buffing" -- Needs review
...
L["Wait before announcing to see if others have announced first in order to reduce spam"] = "Подождать прежде чем сообщать, чтобы посмотреть не сообщит ли кто-нибудь ещё (для уменьшения спама)"
...
L["Warns when your taunts fail due to resist"] = "Предупредить, если ваш таунт промазал из-за резиста"
...
L["Warn to party when one of your taunts fails due to resist"] = "Предупреждать группу, если ваш таунт промазал"
...
L["Warn to raid chat when one of your taunts fails due to resist"] = "Предупреждать в рейд-чат, если ваш таунт промазал из-за резиста"
...
L["Warn to self when one of your taunts fails due to resist"] = "Предупредить себя, если ваш таунт промазал из-за резиста"
...
L["When there are multiple people who can provide a missing buff such as Fortitude then only whisper one of them at random who is in range rather than all of them"] = "Когда отсутствующий бафф могут баффнуть несколько людей, шептать случайному в радиусе баффа, а не всем"
...
L["Whisper only one"] = "Шептать только одному"
L["WotLK flasks and elixirs"] = "Настои и эликсиры из TBC" -- Needs review
...
L["NON-TANK %s taunted my boss target (%s%s%s) with %s"] = "НЕ-ТАНК %s стаунтил моего босса (%s%s%s) заклинанием %s"
L["NON-TANK %s taunted my target (%s%s%s) with %s"] = "НЕ-ТАНК %s стаунтил мою цель (%s%s%s) заклинанием %s"
...
L["%s ninjaed my target (%s%s%s) with %s"] = "%s заагрил мою цель (%s%s%s) заклинанием %s"
-- L["%s taunted my boss mob (%s%s%s) with %s"] = ""
L["%s taunted my boss target (%s%s%s) with %s"] = "%s стаунтил мою цель (%s%s%s) заклинанием %s"
L["%s taunted my mob (%s%s%s) with %s"] = "%s стаунтил моего моба (%s%s%s) заклинанием %s"
L["%s taunted my target (%s%s%s) with %s"] = "%s стаунтил мою цель (%s%s%s) заклинанием %s"

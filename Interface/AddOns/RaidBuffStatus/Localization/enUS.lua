...
L["beta"] = true
L["Black Temple"] = true
L["Blessing of Kings is not needed because you are grouped with a Druid."] = true
L["Blessing of Kings, with this raid configuration, is better provided by Drums of the Forgotten Kings thus allowing Blessing of Might to be used."] = true
...
L["BoW"] = true
L["Buffers: "] = true
L["Buffing Kings:"] = true
L["Buffing Might:"] = true
L["Cast by:"] = true
...
L["Hyjal Summit"] = true
L["I am queued for a battlefield."] = true
L["I am queued for a dungeon."] = true
L["[IMMUNE]"] = true
L["Int"] = true
L[" in their bags"] = true
L["Invite auto-accepted from battle.net friend %s."] = true
L["Invite auto-accepted from friend %s."] = true
L["Invite auto-accepted from guild member %s."] = true
L["Item count: "] = true
...
L["Missing or not working oRA or RBS: "] = true
...
L["Sorry, I am queued for a battlefield."] = true
L["Sorry, I am queued for a dungeon."] = true
L["Sorry, the group is now full."] = true
L["Soul Well about to expire!"] = true
L["(Spellstone)"] = true
L["Spi"] = true
L["Sta"] = true
L["Stamina increased by 60"] = true
L["Stamina increased by 90"] = true
L["Str"] = true
...
L["You need to whisper the leader instead: "] = true
...
L["Alive"] = true
L["Allow raiders to use level 80 WotLK flasks and elixirs"] = true
L["Alt-left click"] = true
L["Alt-right click"] = true
L["Always hide the Boss R Trash buttons"] = true
L["Announce to raid warning when a Cauldron is prepared"] = true
L["Announce to raid warning when a Feast is prepared"] = true
...
L["Anti spam"] = true
L["Appearance"] = true
L["Auto-accept invites"] = true
L["Auto-invite whispers"] = true
L["Automatically accept invites from friends and guild members so you can go for a bio-break whilst waiting for a raid invite"] = true
L["Automatically accept invites from these"] = true
L["Automatically configures the dashboard buffs and configuration defaults for your class or raid leading role"] = true
L["Automatically invite friends and guild members who whisper to you the word 'invite'"] = true
L["Automatically invite these"] = true
...
L["Automatically whisper anyone missing flasks or elixirs when your Cauldron expire warnings appear"] = true
L["Automatically whisper anyone missing Well Fed when your Feast expire warnings appear"] = true
L["Automation"] = true
L["Background colour"] = true
L["Bar positioning"] = true
L["Battle.net friends"] = true
L["Best - %s stamina"] = true
L["Border colour"] = true
L["Bosses only"] = true
L["Bottom"] = true
L["Buff button sorting"] = true
L["Buff Options scale"] = true
L["Buff those missing buff"] = true
L["Buff Wizard"] = true
L["Cauldron"] = true
L["Cauldron auto whisper"] = true
L["CC-break warnings"] = true
L["Choose either one big collection of buff checks or traditional style with Warnings, Trash and Boss buff checks"] = true
L["Choose where on the dashboard the bars appear"] = true
L["Class-specific buffs"] = true
L["Combat"] = true
L["Combat options"] = true
L["Configure how the buff buttons and status bars on the dashboard are sorted and displayed"] = true
...
L["Dashboard scale"] = true
L["Death warnings"] = true
L["Default order"] = true
...
L["Food raid warning announcement options for things like Feasts"] = true
L["Friends"] = true
L["Good food only"] = true
L["Good - %s stamina"] = true
L["Good TBC"] = true
L["Grouping style"] = true
L["Guild members"] = true
L["Healer death"] = true
L["Healer drinking"] = true
L["Healer drinking sound"] = true
L["Healer mana"] = true
...
L["Minimap icon"] = true
L["Minimum remaining buff duration in minutes. Buffs with less than this will be considered as missing.  This option only takes affect when the corresponding 'buff' button is enabled on the dashboard."] = true
L["Min remaining buff duration"] = true
L["Misdirection warnings"] = true
L["Mouse buttons"] = true
L["Move with Alt-click"] = true
L["My buffs"] = true
L["Ninja taunts"] = true
L["No healer close"] = true
L["None"] = true
...
L["One big group"] = true
L["One group down"] = true
L["Only allow food that is 90 Stamina and other stats.  I.e. only allow the top quality food with highest stats"] = true
...
L["Options for automatically opening the dashboard and moving it"] = true
...
L["Play a sound when a healer drinks and is not full on mana"] = true
...
L["Right click"] = true
L["Scale the Buff Options window"] = true
L["Scale the dashboard window"] = true
...
L["Select which level of food quality you require for the raiders to be considered 'Well Fed'"] = true
L["Self buffs"] = true
L["Set how many seconds between dashboard raid scan updates"] = true
L["Set N - the number of people missing a buff considered to be \"MANY\""] = true
...
L["Tells you when someone in your party, raid or guild has RBS installed"] = true
L["Test"] = true
...
L["Then sort buff buttons by"] = true
...
L["Top"] = true
L["To set this option go to the addon configuration.  This button is automatically enabled when the Boss button is pressed and automatically disabled when the Trash button is pressed.  To permanently disable, choose 0 seconds as the min remaining buff duration."] = true
L["Two groups down"] = true
L["Use Pally Power"] = true
L["User announce"] = true
...
L["Warning, Trash, Boss groups"] = true
...
L["WotLK flasks and elixirs"] = true

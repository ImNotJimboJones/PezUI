...
L["Blessing of Kings, with this raid configuration, is better provided by Drums of the Forgotten Kings thus allowing Blessing of Might to be used."] = "현재 레이드 구성상, 잊혀진 왕의 북이 왕의 축복보다 부분적으로 좋은 성능을 제공합니다. 따라서, 다른 축복을 사용하세요." -- Needs review
...
L["Missing or not working oRA or RBS: "] = "oRA2를 사용하지 않음" -- Needs review
...
L["Stamina increased by 90"] = "체력 40만큼 증가" -- Needs review
L["Str"] = "힘"
-- L["Sunwell Plateau"] = ""
...
L["Alive"] = "생존자"
L["Allow raiders to use level 80 WotLK flasks and elixirs"] = "70레벨 불타는 성전 비약 및 영약 허용" -- Needs review
...
L["Announce to raid warning when a Feast is prepared"] = "생선 통구이가 준비 되었을 때 공격대 경보로 알려주기" -- Needs review
...
L["Automatically whisper anyone missing Well Fed when your Feast expire warnings appear"] = "생선 통구이가 사라진다는 경고가 나타났을 때, 포만감 버프가 없는 플레이어에게 자동적으로 귓속말을 전송합니다" -- Needs review
-- L["Automation"] = ""
...
L["Feasts"] = "생선 통구이" -- Needs review
L["Food announce"] = "음식 알림"
L["Food raid warning announcement options for things like Feasts"] = "생선 통구이 같은 공격대용 음식에 대한 경고 옵션" -- Needs review
-- L["Friends"] = ""
...
-- L["One big group"] = ""
-- L["One group down"] = ""
-- L["Only allow food that is 90 Stamina and other stats.  I.e. only allow the top quality food with highest stats"] = ""
...
-- L["Set N - the number of people missing a buff considered to be \"MANY\""] = ""
...
-- L["Whisper many"] = ""
-- L["Whisper only one"] = ""
L["WotLK flasks and elixirs"] = "불타는 서전 영약 및 비약" -- Needs review

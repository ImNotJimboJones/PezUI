...
La.Messages = {
	...
	["Remove this button from this dashboard in the buff options window."] = "버프 옵션창에 있는 알림판에서 이 버튼을 삭제합니다.",
	...
	["Shift-Click buffs to report on only that buff."] = "Shift+클릭을 누르면 해당 버프만 보고합니다.",
...
La.Options = {
	Alive = "생존자",
	["Allow raiders to use level 80 WotLK flasks and elixirs"] = "80레벨 불타는 성전 비약 및 영약 허용",
	["Alt-left click"] = "Alt-클릭",
	["Alt-right click"] = "Alt-우클릭",
	["Always hide the Boss R Trash buttons"] = "보스 R 휴지통 버튼을 항상 숨깁니다",
	["Announce to raid warning when a Cauldron is prepared"] = "가마솥이 준비되었을 때 공격대 경보로 알려주기",
	...
	["Automatically accept invites from friends and guild members so you can go for a bio-break whilst waiting for a raid invite"] = "공격대 초대를 기다리며 쉬는 동안 친구나 길드원의 초대를 자동으로 수락합니다.",
	...
	["Buff Wizard"] = "버프 마법사",
	Cauldron = "통구이",
	["Cauldron auto whisper"] = "통구이 자동 귓속말",
	...
	["Danielbarron broke Sheep on The Lich King with Hand of Reckoning"] = "Danielbarron이 리치왕에게 걸린 변이를 심판의 손길로 깨트렸습니다.",
	["Darinia ninjaed my target (The Lich King) with Taunt"] = "Darinia가 자신의 대상(리치왕)을 도발로 훔쳐갔습니다",
	["Darinia taunted my mob (The Lich King) with Taunt"] = "Darinia가 자신의 몹(리치왕)을 도발로 도발했습니다.",
	["Darinia taunted my target (The Lich King) with Taunt"] = "Darinia가 자신의 대상(리치왕)을 도발로 도발했습니다.",
	...
	["Hide and show the buff report dashboard."] = "알림판에 버프 기록을 표시/숨김",
	["Hide Boss R Trash"] = "보스 R 휴지통 숨기기",
	["Hide dashboard during combat"] = "전투동안에 알림판을 숨깁니다",
	["Hide in combat"] = "전투중 숨기기",
	["Hide the buff report dashboard."] = "알림판에 버프기록을 표시하지 않습니다.",
	["Highlight my buffs"] = "내 버프 강조",
	["Hightlight currently missing buffs on the dashboard for which you are responsible including self buffs and buffs which you are missing that are provided by someone else. I.e. show buffs for which you must take action"] = "본인 담당 또는 다른 사람에 의해서 시전된 버프가 누락된 경우 알림판에 강조합니다. 즉 버프가 표시되면 조취를 취해야 합니다.",
	["How MANY?"] = "'다수'란?",
	["Ignore groups 6 to 8"] = "파티 6 - 8 무시",
	["Ignore groups 6 to 8 when reporting as these are for subs"] = "6 - 8 파티의 상황은 보고하지 않습니다.",
	["[IMMUNE] Danielbarron FAILED TO TAUNT their target (The Lich King) with Hand of Reckoning"] = "[면역] Danielbarron이 심판의 손길로 그들의 대상(리치킹)을 도발하는데 실패했습니다.",
	["In range"] = "사거리 안",
	invite = "초대",
	...
	["Minimum remaining buff duration in minutes. Buffs with less than this will be considered as missing.  This option only takes affect when the corresponding 'buff' button is enabled on the dashboard."] = "버프의 최소지속시간 이하인 경우 누락된 것으로 간주합니다. 이 옵션은 해당 버프 버튼이 알림판에 활성화 되어 있을 경우에만 적용됩니다.",
	...
	["Non-tank Glamor broke Hex on The Lich King with Moonfire"] = "비탱커 Glamor가 리치왕에 걸린 주술을 달빛 섬광으로 깨트렸습니다.",
	["NON-TANK Tanagra taunted my target (The Lich King) with Growl"] = "비탱커 Tanagra가 내 대상(리치왕)을 포효로 도발했습니다.",
	...
	["[RESIST] Danielbarron FAILED TO TAUNT their target (The Lich King) with Hand of Reckoning"] = "[저항] Danielbarro 심판의 손길로 그들의 대상 (리치킹) 도발에 실패했습니다",
	["[RESIST] Darinia FAILED TO TAUNT my target (The Lich King) with Taunt"] = "[저항] Darinia가 도발로 내 대상(리치킹) 도발에 실패했습니다.",
	["Right click"] = "우클릭",
	...
	["Show the buff report dashboard."] = "버프 알림판을 표시합니다.",
	...
	["Tells you when someone in your party, raid or guild has RBS installed"] = "당신의 파티나 공격대 혹은 길드에 RBS를 설치한 사람이 있으면 알려줍니다.",
	Test = "테스트",
	...
	["The Buff Wizard automatically configures the dashboard buffs and configuration defaults for your class or raid leading role."] = "버프 마법사는 자신의 직업 또는 공격대장 역할을 위한 기본설정값을 이용해 알림판을 자동으로 구성합니다.",
	...
	Top = "상단",
	["To set this option go to the addon configuration.  This button is automatically enabled when the Boss button is pressed and automatically disabled when the Trash button is pressed.  To permanently disable, choose 0 seconds as the min remaining buff duration."] = "이 옵션을 설정하려면 애드온 설정창으로 가야합니다. 이 버튼은 보스 버튼을 누르면 자동으로 활성화되고 휴지통 버튼을 누르면 자동으로 비활성화됩니다. 계속 비활성화 하려면, 남은 버프의 최소지속시간을 0 초로 변경합니다.",
	...
	["WotLK flasks and elixirs"] = "불타는 성전 영약 및 비약",

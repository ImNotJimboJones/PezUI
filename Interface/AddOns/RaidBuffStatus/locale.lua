...
La.Options = {
	...
	["Announce to raid warning when a Refreshment Table is prepared"] = "Schlachtzugswarnung ausgeben, wenn ein Magier einen Erfrischungstisch aufstellt",
	...
	["Announce to raid warning when a Soul Well is prepared"] = "Schlachtzugswarnung ausgeben, wenn ein Hexenmeister einen Seelenbrunnen aufstellt",
	["Anti spam"] = "Anti-Spam",
	Appearance = "Aussehen",

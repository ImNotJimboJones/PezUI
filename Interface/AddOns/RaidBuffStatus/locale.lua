...
Ld.Options = {
	Alive = "Alive",
	["Allow raiders to use level 80 WotLK flasks and elixirs"] = "Allow raiders to use level 80 WotLK flasks and elixirs",
	...
	["Announce to raid warning when a Cauldron is prepared"] = "Announce to raid warning when a Cauldron is prepared",
	["Announce to raid warning when a Feast is prepared"] = "Announce to raid warning when a Feast is prepared",
	["Announce to raid warning when a Refreshment Table is prepared"] = "Announce to raid warning when a Refreshment Table is prepared",
	["Announce to raid warning when a Repair Bot is prepared"] = "Announce to raid warning when a Repair Bot is prepared",
	["Announce to raid warning when a Soul Well is prepared"] = "Announce to raid warning when a Soul Well is prepared",
	["Anti spam"] = "Anti spam",
	...
	["WotLK flasks and elixirs"] = "WotLK flasks and elixirs",
...
La.Options = {
	Alive = "Vivant",
	["Allow raiders to use level 80 WotLK flasks and elixirs"] = "Permettre aux raideurs d'utiliser des flacons / élixirs de WotLK de niveau 80",
	...
	["Announce to raid warning when a Cauldron is prepared"] = "Annonce via l'avertissement raid lorsqu'un chaudron est préparé",
	["Announce to raid warning when a Feast is prepared"] = "Avertissement raid quand un Festin est préparé",
	["Announce to raid warning when a Refreshment Table is prepared"] = "Avertissement raid quand une Table de rafraichissements est préparée.",
	["Announce to raid warning when a Repair Bot is prepared"] = "Annoncer via l'avertissement raid lorsqu'un Robot réparateur est sorti.",
	["Announce to raid warning when a Soul Well is prepared"] = "Avertissement raid quand un puits des âmes est préparé.",
	["Anti spam"] = "Anti Spam",
	...
	["WotLK flasks and elixirs"] = "Flacons et élixirs de WotLK",
...
La.Messages = {
	...
	["Has buff: "] = "Hat Buff: ",
	[" has set us up a Refreshment Table"] = " möchte einen Magiertisch aufstellen!",
	[" has set us up a Repair Bot"] = " hat einen Reparaturbot aufgestellt!",
	[" has set us up a Soul Well"] = " möchte einen Seelenbrunnen aufstellen!",
	...
	["Refreshment Table about to expire!"] = "Magiertisch verschwindet bald!",
...
La.Options = {
	Alive = "Lebendig",
	["Allow raiders to use level 80 WotLK flasks and elixirs"] = "Schlachtzugteilnehmern den Gebrauch von Level 80 WotLK-Fläschchen und -Elixieren gestatten",
	...
	["Announce to raid warning when a Cauldron is prepared"] = "Schlachtzugswarnung ausgeben, wenn jemand einen Kessel aufstellt",
	["Announce to raid warning when a Feast is prepared"] = "Schlachtzugswarnung ausgeben, wenn jemand ein Festmahl zubereitet",
	["Announce to raid warning when a Refreshment Table is prepared"] = "Schlachtzugswarnung ausgeben, wenn ein Magier einen Erfrischungstisch vorbereitet",
	["Announce to raid warning when a Repair Bot is prepared"] = "Schlachtzugswarnung ausgeben, wenn jemand einen Reparaturbot aufstellt",
	["Announce to raid warning when a Soul Well is prepared"] = "Schlachtzugswarnung ausgeben, wenn ein Hexenmeister einen Seelenbrunnen vorbereitet",
	["Anti spam"] = "Anti-Spam",
	Appearance = "Aussehen",
	...
	["WotLK flasks and elixirs"] = "WotLK-Fläschchen und -Elixiere",
...
La.BuffOptionsWindow = {
	...
	-- ["Report on Boss"] = "",
	-- ["Report on Trash"] = "",
	["Show on dashboard"] = "대쉬보드에 보이기",
	["Show/Report in combat"] = "전투중에 보이기/보고하기",
}
La.CrowdControlWarnings = {
	-- ["Melee Swing"] = "",
	["Non-tank %s broke %s on %s%s%s"] = "비탱커 %s님이 %s를 %s%s%s로부터 해제했습니다",
	["Non-tank %s broke %s on %s%s%s with %s"] = "비탱커 %s님이 %s를 %s%s%s로부터 %s를 사용해서 해제했습니다.",
	-- ["%s broke %s on %s%s%s"] = "",
...
La.Messages = {
	...
	["Blessing of Kings, with this raid configuration, is better provided by Drums of the Forgotten Kings thus allowing Blessing of Might to be used."] = "현재 레이드 구성상, 잊혀진 왕의 북이 왕의 축복보다 부분적으로 좋은 성능을 제공합니다. 따라서, 다른 축복을 사용하세요.", -- Needs review
	Boss = "보스",
	["Buffers: "] = "버프 가능자:",
	-- ["Buffing Kings:"] = "",
	-- ["Buffing Might:"] = "",
	-- ["Cast by:"] = "",
	["Click buffs to disable and enable."] = "클릭하시면 버프의 사용 여부를 토글합니다.",
	["Click to toggle the RBS dashboard"] = "클릭 버프 확인창 보기 전환",
	-- ["Ctrl-Click Boss or Trash to whisper all those who need to buff."] = "",
	["Ctrl-Click buffs to whisper those who need to buff."] = "버프를 컨트롤 클릭하면 그 버프가 필요한 사람에게 귓속말을 합니다.",
	Dead = "죽음",
	...
	-- ["Missing buffs (Trash): "] = "",
	["Missing or not working oRA or RBS: "] = "oRA2를 사용하지 않음", -- Needs review
	...
	["Remove this button from this dashboard in the buff options window."] = "버프 옵션창에 있는 대쉬보드에서 이 버튼을 삭제합니다.",
	["Repair Bot about to expire!"] = "수리 로봇이 곧 사라집니다!",
	["[RESIST]"] = "[저항]",
	["Right-click to open the addons options menu"] = "애드온 옵션 메뉴를 열려면 우클릭하세요.",
	["(Rockbiter)"] = "(대지)",
	-- ["%s about to expire!"] = "",
	...
	Scroll = "두루마리",
	Seal = "문장",
	["%s has a newer (%s) version of RBS (%s) than you (%s)"] = "%s의 RBS 버전 (%s)이 당신 (%s)보다 최신버전을 사용합니다.", -- Needs review
	...
	["Stamina increased by 90"] = "체력 40만큼 증가", -- Needs review
	Str = "힘",
	...
	["You need to be leader or assistant to do this"] = "이것을 수행하기 위해서는 공대장이나 승급이 된 사람이어야 합니다.",
	-- ["You need to whisper the leader instead: "] = "",
}
La.Options = {
	Alive = "생존자",
	["Allow raiders to use level 80 WotLK flasks and elixirs"] = "70레벨 불타는 성전 비약 및 영약 허용", -- Needs review
	["Alt-left click"] = "Alt-좌클릭",
	["Alt-right click"] = "Alt-우클릭",
	-- ["Always hide the Boss R Trash buttons"] = "",
	-- ["Announce to raid warning when a Cauldron is prepared"] = "",
	["Announce to raid warning when a Feast is prepared"] = "생선 통구이가 준비 되었을 때 공격대 경보로 알려주기", -- Needs review
	["Announce to raid warning when a Refreshment Table is prepared"] = "원기 회복의 식탁이 준비되었을 때 공격대 경보로 알리기",
	["Announce to raid warning when a Repair Bot is prepared"] = "수리 로봇 준비 시 공격대 경보로 알림",
	["Announce to raid warning when a Soul Well is prepared"] = "원기 회복의 식탁이 준비되었을 때 공격대 경보로 알려주기",
	["Anti spam"] = "스팸 방지",
	Appearance = "외형",
	-- ["Auto-accept invites"] = "",
	...
	["Automatically show the dashboard when you join a battleground"] = "전장 참여시 자동으로 확인창 보기",
	["Automatically show the dashboard when you join a party"] = "파티 참여 시 자동으로 확인창 보기",
	["Automatically show the dashboard when you join a raid"] = "공격대 참여 시 자동으로 확인창 보기",
	["Automatically whisper anyone missing a Healthstone when your Soul Well expire warnings appear"] = "영혼의 샘이 사라진다는 경고를 할 때 생명석을 가지고 있지 않은 사람에게 자동으로 귓속말을 합니다.",
	-- ["Automatically whisper anyone missing flasks or elixirs when your Cauldron expire warnings appear"] = "",
	["Automatically whisper anyone missing Well Fed when your Feast expire warnings appear"] = "생선 통구이가 사라진다는 경고가 나타났을 때, 포만감 버프가 없는 플레이어에게 자동적으로 귓속말을 전송합니다", -- Needs review
	-- Automation = "",
	...
	["Dashboard columns"] = "확인창 칸 수",
	["Dashboard mouse button actions options"] = "확인창 마우스 버튼 설정",
	-- ["Dashboard scale"] = "",
	...
	["Enable warnings when Crowd Control is broken by tanks and non-tanks"] = "탱커나 비탱커에 의해서 군중제어가 해제됐을때 경고를 사용",
	["Enable warnings when Misdirection or Tricks of the Trade is cast"] = "눈속임이나 속임수 거래가 시전되었을 때 경보를 가능하도록 합니다",
	["Feast auto whisper"] = "생선 통구이 자동 귓말",
	Feasts = "생선 통구이", -- Needs review
	["Food announce"] = "음식 알림",
	["Food raid warning announcement options for things like Feasts"] = "생선 통구이 같은 공격대용 음식에 대한 경고 옵션", -- Needs review
	-- Friends = "",
	...
	-- ["Hide Boss R Trash"] = "",
	["Hide dashboard during combat"] = "전투동안에 대쉬보드를 숨깁니다",
	["Hide in combat"] = "전투중에 숨기기",
	...
	["Play a sound when a ranged DPS dies"] = "원거리 딜러 죽음 시 소리 출력",
	...
	["Play a sound when one of your taunts fails due to the target being immune"] = "당신이 사용한 도발이 한번이라도 실패한다면 소리를 재생합니다.",
	...
	-- ["Self buffs"] = "",
	["Set how many seconds between dashboard raid scan updates"] = "dashboard 레이드 스캔의 업데이트 주기를 설정합니다",
	-- ["Set N - the number of people missing a buff considered to be \"MANY\""] = "",
	["Shift-left click"] = "쉬프트 좌클릭",
	["Shift-right click"] = "쉬프트 우클릭",
	...
	-- ["Single target buffs"] = "",
	["Skin and minimap options"] = "스킨과 미니맵 옵션",
	-- ["Skin and scaling"] = "",
	["Skip buff checking during combat. You can manually initiate a scan by pressing Scan on the dashboard"] = "전투동안에 버프 체크를 하지 않습니다. 당신은 이것을 대쉬보드의 검사 버튼을 누름으로써, 체크를 초기화할 수 있습니다.",
	-- ["%s minutes"] = "",
	...
	-- ["Taunts to my mobs"] = "",
	-- ["Taunts to my target"] = "",
	["Tells you when someone in your party, raid or guild has a newer version of RBS installed"] = "당신의 파티나 공격대 혹은 길드의 플레이어가 새 버전의 RBS가 있는지 알려줍니다",
	...
	["The percentage of healers alive in the raid"] = "공격대에서 생존한 힐러의 퍼센트",
	["The percentage of people alive in the raid"] = "공격대에서 생존한 플레이어의 퍼센트",
	["The percentage of people dead in the raid"] = "공격대에서 죽은 공격대원의 퍼센트",
	-- ["The percentage of people within 40 yards range"] = "",
	["The percentage of tanks alive in the raid"] = "공격대에서 생존한 탱커의 퍼센트",
	...
	["Warnings when someone else taunts your target"] = "다른 사람이 당신의 대상을 도발했을 때 알림",
	...
	["Warns when a tank breaks Crowd Control"] = "탱커가 군중제어를 해제했을 때 경고합니다.",
	...
	["Warn to raid chat"] = "공격대창으로 알림",
	["Warn to raid chat when a healer dies"] = "힐러가 죽으면 공격대창으로 경고",
	["Warn to raid chat when a melee DPS dies"] = "밀리 딜러가 죽으면 공격대 창으로 경고",
	["Warn to raid chat when a non-tank breaks Crowd Control"] = "비탱커가 군중제어를 해제했을 때, 공격대 챗으로 경고",
	["Warn to raid chat when a ranged DPS dies"] = "원거리 딜러 죽음 시 공격대에 알림",
	["Warn to raid chat when a tank breaks Crowd Control"] = "탱커가 군중 제어 효과 해제 시 공격대에 알림",
	["Warn to raid chat when a tank dies"] = "탱커가 죽으면 공격대창으로 경고",
	...
	["Warn to raid chat when someone else taunts your target"] = "누군가가 대상을 도발 시 공격대에 알림",
	-- ["Warn to raid chat when someone else taunts your target which is targeting you"] = "",
	["Warn to raid chat when someone else who is not a tank taunts your target"] = "비탱커가 대상 도발 시 공격대에 알림",
	["Warn to raid warning"] = "공격대 경보로 알림",
	["Warn to self"] = "자신에게 알림",
	["Warn to self when a healer dies"] = "힐러가 죽었을 때 자신에게 경고합니다.",
	["Warn to self when a melee DPS dies"] = "근접 딜러가 죽으면 자신에게 경고",
	["Warn to self when a non-tank breaks Crowd Control"] = "비탱커가 군중 제어 효과 해제 시 자신에게 알림",
	["Warn to self when a ranged DPS dies"] = "원거리 딜러 죽음 시 자신에게 알림",
	...
	["Warn using raid warning when a ranged DPS dies"] = "원거리 딜러 죽음 시 공격대 경보로 알림",
	...
	["Warn when a ranged DPS dies"] = "원거리 딜러 죽음 시 알림",
	["Warn when a tank dies"] = "탱커가 죽었을 때 알림",
	["Well auto whisper"] = "영혼의 샘 자동 귓말",
	...
	-- ["Whisper many"] = "",
	-- ["Whisper only one"] = "",
	["WotLK flasks and elixirs"] = "불타는 서전 영약 및 비약", -- Needs review
...
La.Options = {
	-- Alive = "",
	-- ["Allow raiders to use level 80 WotLK flasks and elixirs"] = "",
	-- ["Alt-left click"] = "",
	-- ["Alt-right click"] = "",
	-- ["Always hide the Boss R Trash buttons"] = "",
	-- ["Announce to raid warning when a Cauldron is prepared"] = "",
	-- ["Announce to raid warning when a Feast is prepared"] = "",
	-- ["Announce to raid warning when a Refreshment Table is prepared"] = "",
	-- ["Announce to raid warning when a Repair Bot is prepared"] = "",
	-- ["Announce to raid warning when a Soul Well is prepared"] = "",
	-- ["Anti spam"] = "",
	-- Appearance = "",
	-- ["Auto-accept invites"] = "",
	-- ["Auto-invite whispers"] = "",
...
La.Options = {
	Alive = "Живые",
	["Allow raiders to use level 80 WotLK flasks and elixirs"] = "Позволить рейдерам использовать настои и эликсиры 80-ого уровня из WotLK",
	...
	["Announce to raid warning when a Cauldron is prepared"] = "Сообщать рейду о приготовлении Котла Войны",
	["Announce to raid warning when a Feast is prepared"] = "Извещать рейд о приготовлении Рыбного пира.",
	["Announce to raid warning when a Refreshment Table is prepared"] = "Извещать рейд о приготовлении Стола с яствами.",
	["Announce to raid warning when a Repair Bot is prepared"] = "Сообщить в объявление рейду когда поставлен ремонтный робот",
	["Announce to raid warning when a Soul Well is prepared"] = "Объявлять рейду о создании источника душ",
	["Anti spam"] = "Анти-спам",
	...
	["WotLK flasks and elixirs"] = "Настои и эликсиры их WotLK",
...
La.Options = {
	Alive = "存活",
	["Allow raiders to use level 80 WotLK flasks and elixirs"] = "允许团队玩家使用80级巫妖王之怒合剂和药剂",
	["Alt-left click"] = "Alt+点击",
	["Alt-right click"] = "Alt+右击",
	["Always hide the Boss R Trash buttons"] = "总是隐藏首领和小怪按钮",
	["Announce to raid warning when a Cauldron is prepared"] = "当药锅准备好时团队警报频道发出通告",
	["Announce to raid warning when a Feast is prepared"] = "当鱼肉大餐准备好时团队警报频道发出通告",
	["Announce to raid warning when a Refreshment Table is prepared"] = "当餐桌准备好时向团队警报频道发出通告",
	["Announce to raid warning when a Repair Bot is prepared"] = "当一个修理机器人准备好时通报到团队频道",
	["Announce to raid warning when a Soul Well is prepared"] = "当灵魂之井准备好的时候用团队警报发出通知",
	["Anti spam"] = "防止刷屏",
	Appearance = "外观",
	...
	["WotLK flasks and elixirs"] = "巫妖王之怒合剂和药剂",
...
La.Options = {
	Alive = "Vivos",
	["Allow raiders to use level 80 WotLK flasks and elixirs"] = "Permitir usar frascos y elixires nivel 80 de WotLK",
	...
	["Announce to raid warning when a Refreshment Table is prepared"] = "Anunciar por aviso de banda cuando sacan una Mesa de Refrigerio",
	["Announce to raid warning when a Repair Bot is prepared"] = "Anunciar por aviso de banda cuando saquen un Robot de Reparación",
	["Announce to raid warning when a Soul Well is prepared"] = "Anunciar por aviso de banda cuando se prepare un Ritual de Almas",
	["Anti spam"] = "Anti spam",
	Appearance = "Aspecto",
	-- ["Auto-accept invites"] = "",
	-- ["Auto-invite whispers"] = "",
...
is nice to traslate this hehe.]=],
	...
	-- ["Whisper only one"] = "",
	["WotLK flasks and elixirs"] = "Frascos y elixires de WotLK",
...
La.Options = {
	Alive = "存活",
	["Allow raiders to use level 80 WotLK flasks and elixirs"] = "允許團隊成員使用80級WotLK的精鍊和藥劑",
	["Alt-left click"] = "Alt+左鍵點擊",
	["Alt-right click"] = "Alt+右鍵點擊",
	["Always hide the Boss R Trash buttons"] = "總是隱藏首領 R 小兵按鈕",
	["Announce to raid warning when a Cauldron is prepared"] = "當大鍋準備好時團隊警報頻道發出通告",
	["Announce to raid warning when a Feast is prepared"] = "當準備好一個盛宴時提示到團隊警告中",
	["Announce to raid warning when a Refreshment Table is prepared"] = "當準備好一個餐點桌時提示到團隊警告中",
	["Announce to raid warning when a Repair Bot is prepared"] = "當準備好一個修理機器人時提示到團隊警告中",
	["Announce to raid warning when a Soul Well is prepared"] = "當準備好一個靈魂之井時提示到團隊警告中",
	["Anti spam"] = "垃圾訊息",
	Appearance = "外觀",
	...
	["WotLK flasks and elixirs"] = "WotLK的精鍊和藥劑",
...
La.Messages = {
	...
	["Sorry, I am queued for"] = "Desculpe, Estou em fila para uma masmorra ou raide.", -- Needs review
...
La.Options = {
	Alive = "Vivo",
	["Allow raiders to use level 80 WotLK flasks and elixirs"] = "Permitir raiders usarem frasco e elixir nivel 80 WotLK",
	...
	["Announce to raid warning when a Cauldron is prepared"] = "Anunciar no alerta de raide quando um Caldeirão é preparado",
	["Announce to raid warning when a Feast is prepared"] = "Anunciar no alerta de raide quando um Banquete for preparado",
	["Announce to raid warning when a Refreshment Table is prepared"] = "Anunciar no alerta de raide quando uma Mesa da Fartura for preparada.",
	["Announce to raid warning when a Repair Bot is prepared"] = "Anunciar no alerta de raide quando um Robô de Conserto for preparado",
	["Announce to raid warning when a Soul Well is prepared"] = "Anunciar no alerta de raide quando um Poço das Almas for preparado",
	["Anti spam"] = "Anti spam",
	...
	["WotLK flasks and elixirs"] = "Frascos e elixir WotLK",

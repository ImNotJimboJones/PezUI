...
La.Options = {
	Alive = "Lebendig",
	["Allow raiders to use flasks and elixirs from last expansion"] = "Schlachtzugteilnehmern den Gebrauch von Level 80 WotLK-Fläschchen und -Elixieren gestatten", -- Needs review
	...
	["Old flasks and elixirs"] = "WotLK-Fläschchen und -Elixiere", -- Needs review
...
La.Options = {
	...
	["Announce to raid warning when a Soul Well is prepared"] = "영혼의 샘이 준비되었을 때 공격대 경보로 알려주기",
	["Anti spam"] = "스팸 방지",
	Appearance = "외형",

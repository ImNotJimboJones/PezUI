...
L["Dungeon Helper: Bonus available!"] = "Dungeon Helper: 추가 보상 가능!" -- Needs review
...
L["Options"] = "설정"
L["Play Alert"] = "시간 알림"
L["Play Bonus Sound"] = "추가 보상 가능 시 알림음 재생" -- Needs review
L["Play Invitation Sound"] = "파티 초대음 재생" -- Needs review
L["Play the selected Sound when the group is ready."] = "파티 준비 시 선택한 소리를 재생." -- Needs review
L["Queued for: "] = "유형:"
L["Raid completed in"] = "공격대 완료 " -- Needs review
L["Remaining"] = "남음" -- Needs review
L["Report Time to Party"] = "파티에 던전 완료 시간 알리기"
L["Report To Chat"] = "대화창에 표시" -- Needs review
...
L["Warning: Some of the sounds may depend on other addons."] = "경고: 몇가지 소리는 다른 애드온의 영향을 받습니다." -- Needs review
...
L["Cata"] = "浩劫與重生"
L["Clear the box to disable this."] = "清除輸入框來禁用。"
...
L["Queued for: "] = "排隊等待："
L["Raid completed in"] = "團隊完成於" -- Needs review
L["Remaining"] = "剩餘"
...
L["You need to have a Data Broker Display to see this Plugin."] = "你必須要有Data Broker顯示來看插件。"
L["Zandalari"] = "贊達拉"
...
L["Display Type"] = "显示类型"
L["DPS"] = "伤害输出"
L["Dungeon completed in"] = "地下城完成于"
L["Dungeon Helper: Bonus available!"] = "地下城助手:奖励开启!"
L["End Message"] = "结束讯息"
L["Find Group"] = "寻找队伍"
L["General"] = "常规"
L["H"] = "治疗"
...
L["Queued for: "] = "排队等待:"
L["Raid completed in"] = "团队完成于" -- Needs review
L["Remaining"] = "剩余"
L["Report Time to Party"] = "通告时间到队伍频道"
L["Report To Chat"] = "通告到聊天頻道"
L["Right-Click for options."] = "右键-点击 打开选项"
L["Second"] = "秒"
L["Seconds"] = "秒"
L["Select Sound"] = "选择音效"
L["Sends a message to the party chat at the beginning of the dungeon."] = "在地下城开始时发送讯息到小队頻道."
L["Sends a message to the party chat at the end of the dungeon."] = "在地下城结束时发送讯息到小队頻道."
L["Short Text"] = "简短的文字"
L["Show a leave party dialog at the end of a random dungeon."] = "随机地下城结束时显示离开小队框体"
L["Show Instance Name"] = "显示地下城名称"
L["Show Time"] = "显示时间"
L["Show Timer Bar"] = "显示时间条"
L["Show Wait Time"] = "显示等待时间"
L["Start Message"] = "开始讯息"
L["T"] = "坦"
L["Tank"] = "坦克"
...
L["Watch"] = "观察"
L["Watch for Call To Arms (Bonus rewards) availability."] = "监视战争的号角(额外奖励)是否可用"

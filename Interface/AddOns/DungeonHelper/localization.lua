...
L["Cata"] = "浩劫與重生"
L["Clear the box to disable this."] = "清除此框停用該功能." -- Needs review
...
L["Queued for: "] = "排隊等待："
L["Raid completed in"] = "本次團隊副本用時" -- Needs review
L["Remaining"] = "剩餘"
...
L["Shift-Click to open the raid finder."] = "Shift+左鍵開啟團隊搜尋器" -- Needs review
L["Short Text"] = "簡短文字"
...
L["You need to have a Data Broker Display to see this Plugin."] = "你必須要有Data Broker顯示插件才能看到插件。" -- Needs review
L["Zandalari"] = "贊達拉"
